...
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (1, '首页', 1, 1, 1, 0, '/home', '', 'dashboardoutlined', '首页');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (2, '权限管理', 1, 1, 2, 0, '/system', '', 'settingoutlined', '权限管理');

-- 配置用户信息权限
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (3 ,'用户管理', 2, 1, 1, 2, '/system/user', '', 'useroutlined', '用户信息管理');

select * from sys_menu where menu_name='用户管理';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (4 ,'添加用户信息', 3, 1, 1, 3, '', '/api/system/user/adduser', '', '添加用户信息');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (5 ,'删除用户信息', 3, 1, 2, 3, '', '/api/system/user/deleteuser', '', '删除用户信息');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (6 ,'更新用户信息', 3, 1, 3, 3, '', '/api/system/user/updateuser', '', '更新用户信息');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (7 ,'更新用户信息状态', 3, 1, 4, 3, '', '/api/system/user/updateuserstatus', '', '更新用户信息状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (8 ,'更新用户密码', 3, 1, 4, 3, '', '/api/system/user/updateuserpassword', '', '更新用户密码');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (9 ,'查询用户信息详情', 3, 1, 5, 3, '', '/api/system/user/queryuserdetail', '', '查询用户信息详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (10 ,'查询用户信息列表', 3, 1, 6, 3, '', '/api/system/user/queryuserlist', '', '查询用户信息列表');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (11 ,'用户登录', 3, 1, 7, 3, '', '/api/system/user/login', '', '用户登录');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (12 ,'查询用户菜单列表', 3, 1, 8, 3, '', '/api/system/user/queryusermenu', '', '查询用户菜单列表');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (13 ,'查询用户角色信息', 3, 1, 9, 3, '', '/api/system/user/queryuserrole', '', '查询用户角色信息');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (14 ,'更新用户角色信息', 3, 1, 10, 3, '', '/api/system/user/updateuserrole', '', '更新用户角色信息');

-- 配置角色信息权限
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (15 ,'角色管理', 2, 1, 2, 2, '/system/role', '', 'usergroupaddoutlined', '角色信息管理');

select * from sys_menu where menu_name='角色管理';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (16 ,'添加角色信息', 3, 1, 1, 15, '', '/api/system/role/addrole', '', '添加角色信息');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (17 ,'删除角色信息', 3, 1, 2, 15, '', '/api/system/role/deleterole', '', '删除角色信息');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (18 ,'更新角色信息', 3, 1, 3, 15, '', '/api/system/role/updaterole', '', '更新角色信息');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (19 ,'更新角色信息状态', 3, 1, 4, 15, '', '/api/system/role/updaterolestatus', '', '更新角色信息状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (20 ,'查询角色信息详情', 3, 1, 5, 15, '', '/api/system/role/queryroledetail', '', '查询角色信息详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (21 ,'查询角色信息列表', 3, 1, 6, 15, '', '/api/system/role/queryrolelist', '', '查询角色信息列表');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (22 ,'查询角色菜单列表', 3, 1, 7, 15, '', '/api/system/role/queryrolemenu', '', '查询角色菜单列表');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (23 ,'更新角色菜单信息', 3, 1, 8, 15, '', '/api/system/role/updaterolemenu', '', '更新角色菜单信息');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (24 ,'查询已分配用户角色', 3, 1, 8, 15, '', '/api/system/role/queryallocatedlist', '', '查询已分配用户角色');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (25 ,'查询未分配用户角色', 3, 1, 8, 15, '', '/api/system/role/queryunallocatedlist', '', '查询未分配用户角色');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (26 ,'取消授权用户', 3, 1, 8, 15, '', '/api/system/role/cancelauthuser', '', '取消授权用户');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (27 ,'批量取消授权用户', 3, 1, 8, 15, '', '/api/system/role/batchcancelauthuser', '', '批量取消授权用户');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (28 ,'批量选择用户授权', 3, 1, 8, 15, '', '/api/system/role/batchauthuser', '', '批量选择用户授权');

-- 配置菜单信息权限
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (29 ,'菜单管理', 2, 1, 3, 2, '/system/menu', '', 'menuoutlined', '菜单信息管理');

select * from sys_menu where menu_name='菜单管理';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (30 ,'添加菜单', 3, 1, 1, 29, '', '/api/system/menu/addmenu', '', '添加菜单');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (31 ,'删除菜单', 3, 1, 2, 29, '', '/api/system/menu/deletemenu', '', '删除菜单');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (32 ,'更新菜单', 3, 1, 3, 29, '', '/api/system/menu/updatemenu', '', '更新菜单');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (33 ,'更新菜单状态', 3, 1, 4, 29, '', '/api/system/menu/updatemenustatus', '', '更新菜单状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (34 ,'查询菜单详情', 3, 1, 5, 29, '', '/api/system/menu/querymenudetail', '', '查询菜单详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values ( 35,'查询菜单列表', 3, 1, 6, 29, '', '/api/system/menu/querymenulist', '', '查询菜单列表');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values ( 36,'查询菜单树', 3, 1, 6, 29, '', '/api/system/menu/querymenulistsimple', '', '查询菜单树');


-- 配置部门权限
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (37 ,'部门管理', 2, 1, 4, 2, '/system/dept', '', 'apartmentoutlined', '部门管理');

select * from sys_menu where menu_name='部门管理';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (38 ,'添加部门', 3, 1, 1, 37, '', '/api/system/dept/adddept', '', '添加部门');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (39 ,'删除部门', 3, 1, 2, 37, '', '/api/system/dept/deletedept', '', '删除部门');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (40 ,'更新部门', 3, 1, 3, 37, '', '/api/system/dept/updatedept', '', '更新部门');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (41 ,'更新部门状态', 3, 1, 4, 37, '', '/api/system/dept/updatedeptstatus', '', '更新部门状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values ( 42,'查询部门详情', 3, 1, 5, 37, '', '/api/system/dept/querydeptdetail', '', '查询部门详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values ( 43,'查询部门列', 3, 1, 6, 37, '', '/api/system/dept/querydeptlist', '', '查询部门列');

-- 配置岗位权限
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (44 ,'岗位管理', 2, 1, 5, 2, '/system/post', '', 'auditoutlined', '岗位管理');

select * from sys_menu where menu_name='岗位管理';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (45 ,'添加岗位', 3, 1, 1, 44, '', '/api/system/post/addpost', '', '添加岗位');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (46 ,'删除岗位', 3, 1, 2, 44, '', '/api/system/post/deletepost', '', '删除岗位');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (47 ,'更新岗位', 3, 1, 3, 44, '', '/api/system/post/updatepost', '', '更新岗位');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (48 ,'更新岗位状态', 3, 1, 4, 44, '', '/api/system/post/updatepoststatus', '', '更新岗位状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (49 ,'查询岗位详情', 3, 1, 5, 44, '', '/api/system/post/querypostdetail', '', '查询岗位详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (50 ,'查询岗位列', 3, 1, 6, 44, '', '/api/system/post/querypostlist', '', '查询岗位列');

-- 配置字典类型权限
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (51 ,'字典类型', 2, 1, 6, 2, '/system/dicttype', '', 'tableoutlined', '字典类型管理');

select * from sys_menu where menu_name='字典类型';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (52 ,'添加字典类型', 3, 1, 1, 51, '', '/api/system/dicttype/adddicttype', '', '添加字典类型');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (53 ,'删除字典类型', 3, 1, 2, 51, '', '/api/system/dicttype/deletedicttype', '', '删除字典类型');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (54 ,'更新字典类型', 3, 1, 3, 51, '', '/api/system/dicttype/updatedicttype', '', '更新字典类型');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (55 ,'更新字典类型状态', 3, 1, 4, 51, '', '/api/system/dicttype/updatedicttypestatus', '', '更新字典类型状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (56 ,'查询字典类型详情', 3, 1, 5, 51, '', '/api/system/dicttype/querydicttypedetail', '', '查询字典类型详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (57 ,'查询字典类型列', 3, 1, 6, 51, '', '/api/system/dicttype/querydicttypelist', '', '查询字典类型列');

-- 配置字典数据权限
insert into sys_menu (id, menu_name, menu_type, status, visible, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (58 ,'字典数据', 2, 1, 0,7, 2, '/system/dictdata', '', 'ungroupoutlined', '字典数据管理');

select * from sys_menu where menu_name='字典数据';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (59 ,'添加字典数据', 3, 1, 1, 58, '', '/api/system/dictdata/adddictdata', '', '添加字典数据');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (60 ,'删除字典数据', 3, 1, 2, 58, '', '/api/system/dictdata/deletedictdata', '', '删除字典数据');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (61 ,'更新字典数据', 3, 1, 3, 58, '', '/api/system/dictdata/updatedictdata', '', '更新字典数据');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (62 ,'更新字典数据状态', 3, 1, 4, 58, '', '/api/system/dictdata/updatedictdatastatus', '', '更新字典数据状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (63 ,'查询字典数据详情', 3, 1, 5, 58, '', '/api/system/dictdata/querydictdatadetail', '', '查询字典数据详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (64 ,'查询字典数据列', 3, 1, 6, 58, '', '/api/system/dictdata/querydictdatalist', '', '查询字典数据列');

-- 配置通知公告权限
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (65 ,'通知公告', 2, 1, 8, 2, '/system/notice', '', 'messageoutlined', '通知公告管理');

select * from sys_menu where menu_name='通知公告';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (66 ,'添加通知公告', 3, 1, 1, 65, '', '/api/system/notice/addnotice', '', '添加通知公告');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (67 ,'删除通知公告', 3, 1, 2, 65, '', '/api/system/notice/deletenotice', '', '删除通知公告');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (68 ,'更新通知公告', 3, 1, 3, 65, '', '/api/system/notice/updatenotice', '', '更新通知公告');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (69 ,'更新通知公告状态', 3, 1, 4, 65, '', '/api/system/notice/updatenoticestatus', '', '更新通知公告状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (70 ,'查询通知公告详情', 3, 1, 5, 65, '', '/api/system/notice/querynoticedetail', '', '查询通知公告详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (71 ,'查询通知公告列', 3, 1, 6, 65, '', '/api/system/notice/querynoticelist', '', '查询通知公告列');

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (72 ,'日志管理', 1, 1, 2, 0, '/log', '', 'filteroutlined', '日志管理');
select * from sys_menu where menu_name='日志管理';

-- 配置系统访问记录权限
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (73 ,'登录日志', 2, 1, 9, 72, '/log/loginlog', '', 'deleteoutlined', '系统访问记录管理');

select * from sys_menu where menu_name='登录日志';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (74 ,'添加系统访问记录', 3, 1, 1, 73, '', '/api/system/loginlog/addloginlog', '', '添加系统访问记录');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (75 ,'删除系统访问记录', 3, 1, 2, 73, '', '/api/system/loginlog/deleteloginlog', '', '删除系统访问记录');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (76 ,'清空系统登录日志', 3, 1, 3, 73, '', '/api/system/loginlog/cleanloginlog', '', '清空系统登录日志');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (77 ,'更新系统访问记录状态', 3, 1, 4, 73, '', '/api/system/loginlog/updateloginlogstatus', '', '更新系统访问记录状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (78 ,'查询系统访问记录详情', 3, 1, 5, 73, '', '/api/system/loginlog/queryloginlogdetail', '', '查询系统访问记录详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (79 ,'查询系统访问记录列', 3, 1, 6, 73, '', '/api/system/loginlog/queryloginloglist', '', '查询系统访问记录列');


-- 配置操作日志记录权限
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (80 ,'操作日志', 2, 1, 10, 72, '/log/operatelog', '', 'clearoutlined', '操作日志记录管理');

select * from sys_menu where menu_name='操作日志';

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (81 ,'添加操作日志记录', 3, 1, 1, 80, '', '/api/system/operatelog/addoperatelog', '', '添加操作日志记录');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (82 ,'删除操作日志记录', 3, 1, 2, 80, '', '/api/system/operatelog/deleteoperatelog', '', '删除操作日志记录');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (83 ,'清空操作日志记录', 3, 1, 3, 80, '', '/api/system/operatelog/cleanoperatelog', '', '清空操作日志记录');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (84,'更新操作日志记录状态', 3, 1, 4, 80, '', '/api/system/operatelog/updateoperatelogstatus', '', '更新操作日志记录状态');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (85 ,'查询操作日志记录详情', 3, 1, 5, 80, '', '/api/system/operatelog/queryoperatelogdetail', '', '查询操作日志记录详情');
insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (86 ,'查询操作日志记录列', 3, 1, 6, 80, '', '/api/system/operatelog/queryoperateloglist', '', '查询操作日志记录列');


insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values (87 ,'其他', 1, 1, 3, 0, '/other', '', 'audiooutlined', '其他');

insert into sys_menu (id, menu_name, menu_type, status, menu_sort, parent_id, menu_url, api_url, menu_icon, remark) values ( 88,'查询菜单资源', 3, 1, 7, 29, '', '/api/system/menu/querymenuresourcelist', '', '查询菜单资源');
