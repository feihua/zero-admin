...
-- 插入商品SPU数据
insert into pms_product_spu (id, name, subTitle, product_sn, category_id, category_ids, category_name, brand_id, brand_name, unit, weight, keywords, album_pics, main_pic, price_range, publish_status, new_status, recommend_status, verify_status, preview_status, sort, new_status_sort, recommend_status_sort, sales, stock, low_stock, promotion_type, detail_html, detail_mobile_html, create_by, create_time, update_by, update_time, is_deleted)
