...
-- 插入商品SPU数据
insert into gozero.pms_product_spu (id, name, category_id, category_ids, category_name, brand_id, brand_name, unit, weight, keywords, brief, description, album_pics, main_pic, price_range, publish_status, new_status, recommend_status, verify_status, preview_status, sort, sales, stock, low_stock, promotion_type, detail_title, detail_desc, detail_html, detail_mobile_html, create_by)
