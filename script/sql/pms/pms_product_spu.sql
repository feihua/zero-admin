...
values  (1, 'iPhone 15 Pro', 4, '', 'test', 1, 'test', '台', 0.19, 'iPhone,苹果,手机,A17', 'iPhone 15 Pro 支持USB-C快充，搭载A17 Pro芯片', 'iPhone 15 Pro搭载创新的A17 Pro芯片，采用USB-C接口，支持快充。提供暗紫色、原色和银色三种颜色选择...', 'http://example.com/album/iphone15-1.jpg,http://example.com/album/iphone15-2.jpg,http://example.com/album/iphone15-3.jpg', 'http://129.204.203.29/big.png', '7999-12999', 1, 0, 0, 0, 0, 1, 1000, 0, 0, 0, 'test', 'test', 'test', 'test', 1),
        (2, '华为Mate60 Pro', 4, '', 'test', 2, 'test', '台', 0.23, '华为,Mate60,麒麟芯片', '华为Mate60 Pro 搭载麒麟芯片，支持卫星通讯', '华为Mate60 Pro采用创新的卫星通讯技术，搭载最新麒麟芯片，支持快充技术...', 'http://example.com/album/mate60-1.jpg,http://example.com/album/mate60-2.jpg', 'http://129.204.203.29/big.png', '6999-9999', 1, 0, 0, 0, 0, 2, 800, 0, 0, 0, 'test', 'test', 'test', 'test', 1),
        (3, 'MacBook Pro 14', 5, '', 'test', 1, 'test', '台', 1.60, 'MacBook,苹果,笔记本,M2', 'MacBook Pro 14寸 搭载M2 Pro芯片', 'MacBook Pro 14寸版本搭载最新M2 Pro芯片，提供卓越性能和超长续航...', 'http://example.com/album/macbook-1.jpg,http://example.com/album/macbook-2.jpg', 'http://129.204.203.29/big.png', '14999-19999', 1, 0, 0, 0, 0, 3, 500, 0, 0, 0, 'test', 'test', 'test', 'test', 1),
        (4, '联想小新Pro16', 5, '', 'test', 3, 'test', '台', 1.80, '联想,小新,笔记本,锐龙', '联想小新Pro16 搭载AMD锐龙7处理器', '联想小新Pro16搭载AMD锐龙7处理器，16寸大屏，高色域显示器...', 'http://example.com/album/xiaoxin-1.jpg,http://example.com/album/xiaoxin-2.jpg', 'http://129.204.203.29/big.png', '5999-7999', 1, 0, 0, 0, 0, 4, 600, 0, 0, 0, 'test', 'test', 'test', 'test', 1),
        (5, '美的智能空调', 10, '', 'test', 4, 'test', '台', 12.50, '美的,空调,智能', '美的智能变频空调 1.5匹', '美的智能变频空调，支持WiFi控制，节能省电，制冷制热双效合一...', 'http://example.com/album/ac-1.jpg,http://example.com/album/ac-2.jpg', 'http://129.204.203.29/big.png', '2999-3999', 1, 0, 0, 0, 0, 5, 300, 0, 0, 0, 'test', 'test', 'test', 'test', 1),
        (6, '九阳破壁机', 11, '', 'test', 5, 'test', '台', 4.50, '九阳,破壁机,榨汁', '九阳破壁机 家用多功能', '九阳破壁机，支持热榨，可制作豆浆、果汁、养生饮品...', 'http://example.com/album/juicer-1.jpg,http://example.com/album/juicer-2.jpg', 'http://129.204.203.29/big.png', '799-999', 1, 0, 0, 0, 0, 6, 400, 0, 0, 0, 'test', 'test', 'test', 'test', 1);
