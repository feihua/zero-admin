...
(
    ...
    product_attr       varchar(500)  not null comment '商品销售属性：颜色：红色；尺码：xl;',
    product_count      int           not null comment '退货数量',
    product_price      bigint        not null comment '商品单价',
    product_real_price bigint        not null comment '商品实际支付单价',
    reason             varchar(200)  not null comment '原因',
    description        varchar(500)  not null comment '描述',
    proof_pics         varchar(1000) not null comment '凭证图片，以逗号隔开',
