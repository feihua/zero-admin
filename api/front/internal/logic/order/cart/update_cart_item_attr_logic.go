...
type UpdateCartItemAttrLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewUpdateCartItemAttrLogic(ctx context.Context, svcCtx *svc.ServiceContext) *UpdateCartItemAttrLogic {
	return &UpdateCartItemAttrLogic{
...
func (l *UpdateCartItemAttrLogic) UpdateCartItemAttr(req *types.CartItemReq) (resp *types.CartItemResp, err error) {
	...
	if err != nil {
		logc.Errorf(l.ctx, "更新购物车失败,参数：%+v,响应：%s", req, err.Error())
