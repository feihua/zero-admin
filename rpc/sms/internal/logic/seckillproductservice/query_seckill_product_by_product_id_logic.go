...
type QuerySeckillProductByProductIdLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewQuerySeckillProductByProductIdLogic(ctx context.Context, svcCtx *svc.ServiceContext) *QuerySeckillProductByProductIdLogic {
	return &QuerySeckillProductByProductIdLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
// QuerySeckillProductByProductId 查询秒杀商品详情(app)
func (l *QuerySeckillProductByProductIdLogic) QuerySeckillProductByProductId(in *smsclient.QuerySeckillProductByProductIdReq) (*smsclient.QuerySeckillProductDetailResp, error) {
