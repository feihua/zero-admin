...
type SmsFlashPromotionSession struct {
	...
	StartTime  string    `gorm:"column:start_time;not null;comment:每日开始时间" json:"start_time"`    // 每日开始时间
	EndTime    string    `gorm:"column:end_time;not null;comment:每日结束时间" json:"end_time"`        // 每日结束时间
