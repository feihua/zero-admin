...
// CmsTopicComment mapped from table <cms_topic_comment>
type CmsTopicComment struct {
	...
	CreateTime     time.Time `gorm:"column:create_time;not null;default:CURRENT_TIMESTAMP;comment:评论时间" json:"create_time"` // 评论时间
	ShowStatus     int32     `gorm:"column:show_status;not null;default:1;comment:是否显示，0->不显示；1->显示" json:"show_status"`    // 是否显示，0->不显示；1->显示
}
