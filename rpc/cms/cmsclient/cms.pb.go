...
type UpdateHelpReq struct {
	...
	ReadCount  int32  `protobuf:"varint,7,opt,name=read_count,json=readCount,proto3" json:"read_count,omitempty"`    //
	ShowStatus int32  `protobuf:"varint,8,opt,name=show_status,json=showStatus,proto3" json:"show_status,omitempty"` //
}
...
func (x *QueryHelpListReq) GetPageNum() int64 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QueryHelpListReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type AddHelpCategoryReq struct {
	...
	HelpCount  int32  `protobuf:"varint,2,opt,name=help_count,json=helpCount,proto3" json:"help_count,omitempty"`    //专题数量
	Icon       string `protobuf:"bytes,3,opt,name=icon,proto3" json:"icon,omitempty"`                                //分类图标
	Name       string `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`                                //
	ShowStatus int32  `protobuf:"varint,5,opt,name=show_status,json=showStatus,proto3" json:"show_status,omitempty"` //
...
func (x *QueryHelpCategoryListReq) GetPageNum() int64 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QueryHelpCategoryListReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type AddMemberReportReq struct {
	...
	HandleStatus     int32  `protobuf:"varint,1,opt,name=handle_status,json=handleStatus,proto3" json:"handle_status,omitempty"`              //处理结果：0->无效；1->有效；2->恶意
	...
	ReportObject     string `protobuf:"bytes,4,opt,name=report_object,json=reportObject,proto3" json:"report_object,omitempty"`               //
	...
	ReportType       int32  `protobuf:"varint,6,opt,name=report_type,json=reportType,proto3" json:"report_type,omitempty"`                    //举报类型：0->商品评价；1->话题内容；2->用户评论
}
...
type UpdateMemberReportReq struct {
	...
	HandleStatus     int32  `protobuf:"varint,2,opt,name=handle_status,json=handleStatus,proto3" json:"handle_status,omitempty"`              //处理结果：0->无效；1->有效；2->恶意
	Id               int64  `protobuf:"varint,3,opt,name=id,proto3" json:"id,omitempty"`                                                      //
	Note             string `protobuf:"bytes,4,opt,name=note,proto3" json:"note,omitempty"`                                                   //
	ReportMemberName string `protobuf:"bytes,5,opt,name=report_member_name,json=reportMemberName,proto3" json:"report_member_name,omitempty"` //举报人
	ReportObject     string `protobuf:"bytes,6,opt,name=report_object,json=reportObject,proto3" json:"report_object,omitempty"`               //
	ReportStatus     int32  `protobuf:"varint,7,opt,name=report_status,json=reportStatus,proto3" json:"report_status,omitempty"`              //举报状态：0->未处理；1->已处理
}
...
type UpdateMemberReportStatusReq struct {
	...
	Ids          []int64 `protobuf:"varint,1,rep,packed,name=ids,proto3" json:"ids,omitempty"`
	HandleStatus int32   `protobuf:"varint,2,opt,name=handle_status,json=handleStatus,proto3" json:"handle_status,omitempty"` //处理结果：0->无效；1->有效；2->恶意
	ReportStatus int32   `protobuf:"varint,3,opt,name=report_status,json=reportStatus,proto3" json:"report_status,omitempty"` //举报状态：0->未处理；1->已处理
...
func (x *UpdateMemberReportStatusReq) GetFlag() int32 {
	if x != nil {
		return x.Flag
	}
	return 0
...
type QueryMemberReportDetailResp struct {
	...
	ReportObject     string `protobuf:"bytes,6,opt,name=report_object,json=reportObject,proto3" json:"report_object,omitempty"`               //
	ReportStatus     int32  `protobuf:"varint,7,opt,name=report_status,json=reportStatus,proto3" json:"report_status,omitempty"`              //举报状态：0->未处理；1->已处理
	ReportType       int32  `protobuf:"varint,8,opt,name=report_type,json=reportType,proto3" json:"report_type,omitempty"`                    //举报类型：0->商品评价；1->话题内容；2->用户评论
}
...
type QueryMemberReportListReq struct {
	...
	PageNum          int64  `protobuf:"varint,1,opt,name=page_num,json=pageNum,proto3" json:"page_num,omitempty"`                             //第几页
	PageSize         int64  `protobuf:"varint,2,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`                          //每页的数量
	HandleStatus     int32  `protobuf:"varint,3,opt,name=handle_status,json=handleStatus,proto3" json:"handle_status,omitempty"`              //处理结果：0->无效；1->有效；2->恶意
	ReportMemberName string `protobuf:"bytes,4,opt,name=report_member_name,json=reportMemberName,proto3" json:"report_member_name,omitempty"` //举报人
	ReportStatus     int32  `protobuf:"varint,5,opt,name=report_status,json=reportStatus,proto3" json:"report_status,omitempty"`              //举报状态：0->未处理；1->已处理
	ReportType       int32  `protobuf:"varint,6,opt,name=report_type,json=reportType,proto3" json:"report_type,omitempty"`                    //举报类型：0->商品评价；1->话题内容；2->用户评论
}
...
func (x *QueryMemberReportListReq) GetPageNum() int64 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QueryMemberReportListReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type AddPreferredAreaReq struct {
	...
	Name       string `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`                                //
	Pic        string `protobuf:"bytes,5,opt,name=pic,proto3" json:"pic,omitempty"`                                  //展示图片
	ShowStatus int32  `protobuf:"varint,6,opt,name=show_status,json=showStatus,proto3" json:"show_status,omitempty"` //
}
...
type QueryPreferredAreaDetailResp struct {
	...
	ShowStatus int32  `protobuf:"varint,6,opt,name=show_status,json=showStatus,proto3" json:"show_status,omitempty"` //
	Sort       int32  `protobuf:"varint,7,opt,name=sort,proto3" json:"sort,omitempty"`                               //
	SubTitle   string `protobuf:"bytes,8,opt,name=sub_title,json=subTitle,proto3" json:"sub_title,omitempty"`        //
	UpdateBy   string `protobuf:"bytes,9,opt,name=update_by,json=updateBy,proto3" json:"update_by,omitempty"`        //更新者
	UpdateTime string `protobuf:"bytes,10,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"` //更新时间
}
...
type AddSubjectReq struct {
	...
	AlbumPics       string `protobuf:"bytes,1,opt,name=album_pics,json=albumPics,proto3" json:"album_pics,omitempty"`                     //画册图片用逗号分割
	CategoryId      int64  `protobuf:"varint,2,opt,name=category_id,json=categoryId,proto3" json:"category_id,omitempty"`                 //
	CategoryName    string `protobuf:"bytes,3,opt,name=category_name,json=categoryName,proto3" json:"category_name,omitempty"`            //专题分类名称
	...
	ForwardCount    int32  `protobuf:"varint,10,opt,name=forward_count,json=forwardCount,proto3" json:"forward_count,omitempty"`          //转发数
	...
	Pic             string `protobuf:"bytes,12,opt,name=pic,proto3" json:"pic,omitempty"`                                                 //专题主图
	ProductCount    int32  `protobuf:"varint,13,opt,name=product_count,json=productCount,proto3" json:"product_count,omitempty"`          //关联产品数量
	ReadCount       int32  `protobuf:"varint,14,opt,name=read_count,json=readCount,proto3" json:"read_count,omitempty"`                   //
	RecommendStatus int32  `protobuf:"varint,15,opt,name=recommend_status,json=recommendStatus,proto3" json:"recommend_status,omitempty"` //
}
...
type UpdateSubjectReq struct {
	...
	ReadCount       int32  `protobuf:"varint,14,opt,name=read_count,json=readCount,proto3" json:"read_count,omitempty"`                   //
	RecommendStatus int32  `protobuf:"varint,15,opt,name=recommend_status,json=recommendStatus,proto3" json:"recommend_status,omitempty"` //
	ShowStatus      int32  `protobuf:"varint,16,opt,name=show_status,json=showStatus,proto3" json:"show_status,omitempty"`                //显示状态：0->不显示；1->显示
}
...
type UpdateSubjectStatusReq struct {
	...
	Ids        []int64 `protobuf:"varint,1,rep,packed,name=ids,proto3" json:"ids,omitempty"`
	ShowStatus int32   `protobuf:"varint,2,opt,name=show_status,json=showStatus,proto3" json:"show_status,omitempty"` //显示状态：0->不显示；1->显示
}
...
type QuerySubjectListReq struct {
	...
	PageNum         int64  `protobuf:"varint,1,opt,name=page_num,json=pageNum,proto3" json:"page_num,omitempty"`                         //第几页
	PageSize        int64  `protobuf:"varint,2,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`                      //每页的数量
	RecommendStatus int32  `protobuf:"varint,3,opt,name=recommend_status,json=recommendStatus,proto3" json:"recommend_status,omitempty"` //
...
type AddSubjectCategoryReq struct {
	...
	CreateBy     string `protobuf:"bytes,1,opt,name=create_by,json=createBy,proto3" json:"create_by,omitempty"`              //创建者
	SubjectCount int32  `protobuf:"varint,2,opt,name=subject_count,json=subjectCount,proto3" json:"subject_count,omitempty"` //专题数量
	Icon         string `protobuf:"bytes,3,opt,name=icon,proto3" json:"icon,omitempty"`                                      //分类图标
...
type UpdateSubjectCategoryReq struct {
	...
	SubjectCount int32  `protobuf:"varint,1,opt,name=subject_count,json=subjectCount,proto3" json:"subject_count,omitempty"` //专题数量
	UpdateBy     string `protobuf:"bytes,2,opt,name=update_by,json=updateBy,proto3" json:"update_by,omitempty"`              //更新者
	Icon         string `protobuf:"bytes,3,opt,name=icon,proto3" json:"icon,omitempty"`                                      //分类图标
...
type QuerySubjectCategoryDetailResp struct {
	...
	ShowStatus   int32  `protobuf:"varint,6,opt,name=show_status,json=showStatus,proto3" json:"show_status,omitempty"`       //
	Sort         int32  `protobuf:"varint,7,opt,name=sort,proto3" json:"sort,omitempty"`                                     //
	SubjectCount int32  `protobuf:"varint,8,opt,name=subject_count,json=subjectCount,proto3" json:"subject_count,omitempty"` //专题数量
	UpdateBy     string `protobuf:"bytes,9,opt,name=update_by,json=updateBy,proto3" json:"update_by,omitempty"`              //更新者
	UpdateTime   string `protobuf:"bytes,10,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`       //更新时间
}
...
func (x *QuerySubjectCategoryListReq) GetPageNum() int64 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QuerySubjectCategoryListReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type AddSubjectCommentReq struct {
	...
	MemberIcon     string `protobuf:"bytes,4,opt,name=member_icon,json=memberIcon,proto3" json:"member_icon,omitempty"`               //
	MemberNickName string `protobuf:"bytes,5,opt,name=member_nick_name,json=memberNickName,proto3" json:"member_nick_name,omitempty"` //
}
...
func (x *QuerySubjectCommentListReq) GetPageNum() int64 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QuerySubjectCommentListReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type AddTopicReq struct {
	...
	AttendCount    int32  `protobuf:"varint,1,opt,name=attend_count,json=attendCount,proto3" json:"attend_count,omitempty"`          //参与人数
	AttendType     string `protobuf:"bytes,2,opt,name=attend_type,json=attendType,proto3" json:"attend_type,omitempty"`              //参与方式
	AttentionCount int32  `protobuf:"varint,3,opt,name=attention_count,json=attentionCount,proto3" json:"attention_count,omitempty"` //关注人数
	AwardName      string `protobuf:"bytes,4,opt,name=award_name,json=awardName,proto3" json:"award_name,omitempty"`                 //奖品名称
	CategoryId     int64  `protobuf:"varint,5,opt,name=category_id,json=categoryId,proto3" json:"category_id,omitempty"`             //
	Content        string `protobuf:"bytes,6,opt,name=content,proto3" json:"content,omitempty"`                                      //话题内容
	CreateBy       string `protobuf:"bytes,7,opt,name=create_by,json=createBy,proto3" json:"create_by,omitempty"`                    //创建者
...
func (x *QueryTopicListReq) GetPageNum() int64 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QueryTopicListReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *QueryTopicCategoryListReq) GetPageNum() int64 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QueryTopicCategoryListReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *QueryTopicCommentListReq) GetPageNum() int64 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QueryTopicCommentListReq) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
var file_rpc_cms_cms_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x09, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x22, 0xce,
	0x01, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x48, 0x65, 0x6c, 0x70, 0x52, 0x65, 0x71, 0x12, 0x1f, 0x0a,
	...
	0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x04,
	...
	0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x09, 0x72, 0x65, 0x61, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1f,
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x48, 0x65, 0x6c, 0x70, 0x52, 0x65, 0x71, 0x12, 0x1f, 0x0a,
	0x0b, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0a, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x12, 0x18,
	0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x09, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x69,
	0x63, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12,
	0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12,
	0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x09, 0x72, 0x65, 0x61, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1f,
	...
	0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0x48, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x48,
	...
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x61, 0x74,
	...
	0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x72, 0x65, 0x61, 0x64,
	...
	0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x1b, 0x0a, 0x09,
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x81, 0x01, 0x0a, 0x10, 0x51,
	...
	0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68,
	0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c,
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0xbf,
	0x02, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x70, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12,
	...
	0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72,
	...
	,
	...
	0x22, 0x56, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72, 0x79, 0x48, 0x65, 0x6c, 0x70, 0x4c, 0x69, 0x73,
	...
	0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x63, 0x6d, 0x73, 0x63,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x48, 0x65, 0x6c, 0x70, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61,
	0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xad, 0x01, 0x0a, 0x12, 0x41, 0x64, 0x64,
	0x48, 0x65, 0x6c, 0x70, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x12,
	...
	0x68, 0x65, 0x6c, 0x70, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x09, 0x68, 0x65, 0x6c, 0x70, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x69,
	0x63, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12,
	0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74,
	...
	,
	...
	,
	...
	0x1b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x48, 0x65, 0x6c, 0x70, 0x43, 0x61, 0x74, 0x65, 0x67,
	...
	,
	...
	0x1d, 0x0a, 0x0a, 0x68, 0x65, 0x6c, 0x70, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x09, 0x68, 0x65, 0x6c, 0x70, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12,
	0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x63,
	0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02,
	0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73,
	...
	0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x75,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x87, 0x01, 0x0a, 0x18, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x48, 0x65, 0x6c, 0x70, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c,
	...
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x22, 0x9e, 0x02, 0x0a, 0x14, 0x48, 0x65, 0x6c, 0x70, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a, 0x09,
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x68, 0x65,
	0x6c, 0x70, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09,
	0x68, 0x65, 0x6c, 0x70, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x63, 0x6f,
	...
	0x54, 0x69, 0x6d, 0x65, 0x22, 0x66, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x48, 0x65, 0x6c,
	0x70, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73,
	...
	0x74, 0x2e, 0x48, 0x65, 0x6c, 0x70, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69,
	0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xe6, 0x01, 0x0a,
	0x12, 0x41, 0x64, 0x64, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74,
	0x52, 0x65, 0x71, 0x12, 0x23, 0x0a, 0x0d, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x5f, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x68, 0x61, 0x6e, 0x64,
	0x6c, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x6f, 0x74, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x6f, 0x74, 0x65, 0x12, 0x2c, 0x0a, 0x12,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x72,
	0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0x29, 0x0a, 0x13, 0x41, 0x64, 0x64, 0x4d, 0x65, 0x6d, 0x62,
	0x65, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04,
	0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67,
	0x22, 0x29, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73,
	...
	,
	...
	0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xa0, 0x02, 0x0a, 0x1b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4d,
	...
	0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65,
	0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x68,
	0x61, 0x6e, 0x64, 0x6c, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x72, 0x65, 0x70,
	0x6f, 0x72, 0x74, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x23, 0x0a,
	0x0d, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x06,
	...
	0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x72, 0x65, 0x70, 0x6f, 0x72,
	0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x70, 0x6f, 0x72,
	0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x72, 0x65,
	0x70, 0x6f, 0x72, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0xeb, 0x01, 0x0a, 0x18, 0x51, 0x75, 0x65,
	...
	,
	...
	,
	...
	0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x22, 0x66, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12,
	...
	,
	...
	,
	...
	0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x22, 0x2d, 0x0a,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0x51, 0x0a, 0x1c,
	...
	,
	...
	0x09, 0x73, 0x75, 0x62, 0x5f, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x73, 0x75, 0x62, 0x54, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x70,
	...
	0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xa5, 0x01, 0x0a, 0x19, 0x51, 0x75, 0x65,
	...
	0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x75, 0x62, 0x5f, 0x74, 0x69, 0x74, 0x6c, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x75, 0x62, 0x54, 0x69, 0x74, 0x6c, 0x65,
	0x22, 0x9b, 0x02, 0x0a, 0x15, 0x50, 0x72, 0x65, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x41, 0x72,
	0x65, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72,
	...
	0x70, 0x69, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x70, 0x69, 0x63, 0x12, 0x1f,
	0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20,
	...
	0x6f, 0x72, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x75, 0x62, 0x5f, 0x74, 0x69, 0x74, 0x6c, 0x65,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x75, 0x62, 0x54, 0x69, 0x74, 0x6c, 0x65,
	...
	,
	...
	0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x70, 0x6f, 0x6e, 0x67, 0x22, 0x49, 0x0a, 0x28, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x72, 0x65,
	...
	,
	...
	0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63,
	...
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63,
	...
	0x42, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28,
	...
	0x72, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x0c, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12,
	0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0b,
	...
	,
	...
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74,
	...
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f,
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e,
	0x74, 0x65, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x5f, 0x62, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72,
	...
	0x77, 0x61, 0x72, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x0c, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x10,
	0x0a, 0x03, 0x70, 0x69, 0x63, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x70, 0x69, 0x63,
	...
	,
	...
	0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x2d, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xec,
	0x04, 0x0a, 0x16, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x44,
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x6c, 0x62,
	0x75, 0x6d, 0x5f, 0x70, 0x69, 0x63, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61,
	0x6c, 0x62, 0x75, 0x6d, 0x50, 0x69, 0x63, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x61, 0x74, 0x65,
	...
	0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x43, 0x6f,
	...
	0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74,
	...
	,
	...
	,
	...
	0xe5, 0x04, 0x0a, 0x0f, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x44,
	0x61, 0x74, 0x61, 0x12, 0x1d, 0x0a, 0x0a, 0x61, 0x6c, 0x62, 0x75, 0x6d, 0x5f, 0x70, 0x69, 0x63,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x6c, 0x62, 0x75, 0x6d, 0x50, 0x69,
	0x63, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x5f, 0x69,
	...
	0x67, 0x6f, 0x72, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6c, 0x6c,
	0x65, 0x63, 0x74, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0c, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23, 0x0a,
	...
	0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x06, 0x20,
	...
	,
	...
	0x73, 0x18, 0x10, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x11, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x70, 0x64,
	...
	0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x5c, 0x0a, 0x14, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e,
	0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52,
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x4b, 0x0a, 0x1f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53,
	...
	,
	...
	0x63, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73,
	0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x2c, 0x0a, 0x16,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0x2c, 0x0a, 0x18, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x2f, 0x0a, 0x19, 0x44, 0x65, 0x6c, 0x65,
	...
	,
	...
	,
	...
	0x54, 0x69, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01,
	...
	0x74, 0x12, 0x23, 0x0a, 0x0d, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63,
	0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x5f, 0x62, 0x79, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x42, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69,
	0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x54, 0x69, 0x6d, 0x65, 0x22, 0x8a, 0x01, 0x0a, 0x1b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53, 0x75,
	...
	0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x22, 0xa7, 0x02, 0x0a, 0x17, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x61, 0x74,
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a,
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x62, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x69,
	0x63, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12,
	...
	0x28, 0x05, 0x52, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x73, 0x75, 0x62, 0x6a,
	0x65, 0x63, 0x74, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0c, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1b, 0x0a,
	...
	0x61, 0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xbb, 0x01, 0x0a, 0x14, 0x41, 0x64,
	...
	0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1d, 0x0a,
	0x0a, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x09, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b,
	0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x63, 0x6f, 0x6e, 0x12, 0x28, 0x0a,
	...
	0x69, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x2b, 0x0a, 0x15, 0x41, 0x64, 0x64, 0x53, 0x75,
	...
	0x65, 0x63, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x12, 0x18, 0x0a,
	0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x75, 0x62, 0x6a, 0x65,
	...
	0x62, 0x65, 0x72, 0x49, 0x63, 0x6f, 0x6e, 0x12, 0x28, 0x0a, 0x10, 0x6d, 0x65, 0x6d, 0x62, 0x65,
	...
	0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61, 0x74,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x12, 0x18,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x6d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x5f, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x63, 0x6f, 0x6e, 0x12, 0x28, 0x0a, 0x10, 0x6d, 0x65,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74,
	0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x73, 0x75, 0x62, 0x6a, 0x65,
	0x63, 0x74, 0x49, 0x64, 0x22, 0x9f, 0x01, 0x0a, 0x1a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53, 0x75,
	...
	0x03, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x28, 0x0a, 0x10, 0x6d,
	...
	0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xee, 0x01, 0x0a, 0x16, 0x53, 0x75, 0x62, 0x6a, 0x65,
	0x63, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74,
	...
	0x10, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x6e, 0x69, 0x63, 0x6b, 0x5f, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x4e,
	0x69, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68,
	0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x75, 0x62, 0x6a,
	0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x73, 0x75,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x22, 0x6a, 0x0a, 0x1b, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x63, 0x6d, 0x73,
	0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6c,
	0x69, 0x73, 0x74, 0x22, 0x5c, 0x0a, 0x1c, 0x41, 0x64, 0x64, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74,
	...
	,
	...
	,
	...
	0x79, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x06,
	...
	,
	...
	0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x74, 0x74, 0x65, 0x6e, 0x64, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x74, 0x74, 0x65, 0x6e, 0x64, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x61, 0x74, 0x74, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x61, 0x74, 0x74,
	0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x61,
	0x77, 0x61, 0x72, 0x64, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x61, 0x77, 0x61, 0x72, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x61,
	...
	0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x12,
	0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x72, 0x65, 0x61, 0x64, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18,
	0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d, 0x65,
	...
	0x28, 0x09, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x5f,
	0x0a, 0x11, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x4c, 0x69, 0x73, 0x74,
	0x52, 0x65, 0x71, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x6e, 0x75, 0x6d, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x70, 0x61, 0x67, 0x65, 0x4e, 0x75, 0x6d, 0x12, 0x1b,
	0x0a, 0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	,
	...
	0x65, 0x22, 0x58, 0x0a, 0x12, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x4c,
	...
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x63, 0x6d,
	0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x4c, 0x69, 0x73,
	0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xb4, 0x01, 0x0a, 0x13,
	0x41, 0x64, 0x64, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79,
	0x52, 0x65, 0x71, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x62, 0x79,
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0c, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74,
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x03, 0x20,
	...
	0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x22, 0x2a, 0x0a, 0x14, 0x41, 0x64, 0x64, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x61,
	...
	,
	...
	0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	0x12, 0x0a, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x73,
	0x6f, 0x72, 0x74, 0x22, 0x2d, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x70,
	0x69, 0x63, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12,
	0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f,
	0x6e, 0x67, 0x22, 0x51, 0x0a, 0x1c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x70, 0x69,
	0x63, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x33, 0x0a, 0x1d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54,
	...
	0x65, 0x72, 0x79, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79,
	0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x5f, 0x62, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e,
	...
	,
	...
	0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x22, 0xa5, 0x02, 0x0a, 0x15, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x61, 0x74,
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a,
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x62, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x75, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x68, 0x0a, 0x1a, 0x51,
	...
	0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52,
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xb5, 0x01, 0x0a, 0x12, 0x41, 0x64, 0x64, 0x54, 0x6f, 0x70,
	0x69, 0x63, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x12, 0x18, 0x0a, 0x07,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f,
	0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x74, 0x6f, 0x70, 0x69, 0x63,
	...
	0x63, 0x6f, 0x6e, 0x12, 0x28, 0x0a, 0x10, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x6e, 0x69,
	0x63, 0x6b, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x4e, 0x69, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x29, 0x0a,
	0x13, 0x41, 0x64, 0x64, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74,
	0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01,
	...
	,
	...
	0x6e, 0x12, 0x28, 0x0a, 0x10, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x6e, 0x69, 0x63, 0x6b,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x4e, 0x69, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73,
	0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x2c, 0x0a, 0x16,
	...
	,
	...
	0x01, 0x0a, 0x1b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x6f, 0x6d,
	0x6d, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x12, 0x18,
	0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x68, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x6f, 0x77, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x5f, 0x69,
	0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x49, 0x64,
	0x22, 0x73, 0x0a, 0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x6f,
	...
	,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x5f, 0x69,
	0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x49, 0x64,
	0x22, 0x66, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x6f,
	...
	,
	...
	0x71, 0x1a, 0x27, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x55, 0x70,
	...
	,
	...
	,
	...
	0x61, 0x69, 0x6c, 0x12, 0x26, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e,
	0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x72, 0x65, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x41, 0x72,
	0x65, 0x61, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x1a, 0x27, 0x2e, 0x63, 0x6d,
	0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x72, 0x65,
	0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x41, 0x72, 0x65, 0x61, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c,
	...
	,
	...
	,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x12, 0x23, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x1a, 0x24, 0x2e, 0x63, 0x6d, 0x73, 0x63,
	...
	0x00, 0x12, 0x76, 0x0a, 0x1b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6a, 0x65,
	0x63, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x12, 0x29, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x1a, 0x2a, 0x2e, 0x63, 0x6d,
	...
	0x79, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x28, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74,
	0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65,
	0x71, 0x1a, 0x29, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x51, 0x75,
	...
	,
	...
	0x73, 0x70, 0x22, 0x00, 0x12, 0x61, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x22, 0x2e, 0x63,
	0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53,
	0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71,
	0x1a, 0x23, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x28, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e,
	...
	0x29, 0x2e, 0x63, 0x6d, 0x73, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x55, 0x70, 0x64, 0x61,
	...
	,
	...
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x32, 0x96, 0x02, 0x0a, 0x1d, 0x53,
	0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x65, 0x6c,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x70, 0x0a, 0x19,
	0x41, 0x64, 0x64, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	0x74, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x2e, 0x63, 0x6d, 0x73, 0x63,
	...
	,
	...
	0x64, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x6d, 0x0a,
	0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x26, 0x2e, 0x63, 0x6d, 0x73, 0x63,
	...
	,
	...
	,
}
...
var file_rpc_cms_cms_proto_msgTypes = make([]protoimpl.MessageInfo, 139)
var file_rpc_cms_cms_proto_goTypes = []interface{}{
	...
	(*QueryTopicDetailReq)(nil),                       // 108: cmsclient.QueryTopicDetailReq
	(*QueryTopicDetailResp)(nil),                      // 109: cmsclient.QueryTopicDetailResp
	(*QueryTopicListReq)(nil),                         // 110: cmsclient.QueryTopicListReq
	(*TopicListData)(nil),                             // 111: cmsclient.TopicListData
	(*QueryTopicListResp)(nil),                        // 112: cmsclient.QueryTopicListResp
	(*AddTopicCategoryReq)(nil),                       // 113: cmsclient.AddTopicCategoryReq
	(*AddTopicCategoryResp)(nil),                      // 114: cmsclient.AddTopicCategoryResp
	(*DeleteTopicCategoryReq)(nil),                    // 115: cmsclient.DeleteTopicCategoryReq
	(*DeleteTopicCategoryResp)(nil),                   // 116: cmsclient.DeleteTopicCategoryResp
	(*UpdateTopicCategoryReq)(nil),                    // 117: cmsclient.UpdateTopicCategoryReq
	(*UpdateTopicCategoryResp)(nil),                   // 118: cmsclient.UpdateTopicCategoryResp
	(*UpdateTopicCategoryStatusReq)(nil),              // 119: cmsclient.UpdateTopicCategoryStatusReq
	(*UpdateTopicCategoryStatusResp)(nil),             // 120: cmsclient.UpdateTopicCategoryStatusResp
	(*QueryTopicCategoryDetailReq)(nil),               // 121: cmsclient.QueryTopicCategoryDetailReq
	(*QueryTopicCategoryDetailResp)(nil),              // 122: cmsclient.QueryTopicCategoryDetailResp
	(*QueryTopicCategoryListReq)(nil),                 // 123: cmsclient.QueryTopicCategoryListReq
	(*TopicCategoryListData)(nil),                     // 124: cmsclient.TopicCategoryListData
	(*QueryTopicCategoryListResp)(nil),                // 125: cmsclient.QueryTopicCategoryListResp
	(*AddTopicCommentReq)(nil),                        // 126: cmsclient.AddTopicCommentReq
	(*AddTopicCommentResp)(nil),                       // 127: cmsclient.AddTopicCommentResp
	(*DeleteTopicCommentReq)(nil),                     // 128: cmsclient.DeleteTopicCommentReq
	(*DeleteTopicCommentResp)(nil),                    // 129: cmsclient.DeleteTopicCommentResp
	(*UpdateTopicCommentReq)(nil),                     // 130: cmsclient.UpdateTopicCommentReq
	(*UpdateTopicCommentResp)(nil),                    // 131: cmsclient.UpdateTopicCommentResp
	(*UpdateTopicCommentStatusReq)(nil),               // 132: cmsclient.UpdateTopicCommentStatusReq
	(*UpdateTopicCommentStatusResp)(nil),              // 133: cmsclient.UpdateTopicCommentStatusResp
	(*QueryTopicCommentDetailReq)(nil),                // 134: cmsclient.QueryTopicCommentDetailReq
	(*QueryTopicCommentDetailResp)(nil),               // 135: cmsclient.QueryTopicCommentDetailResp
	(*QueryTopicCommentListReq)(nil),                  // 136: cmsclient.QueryTopicCommentListReq
	(*TopicCommentListData)(nil),                      // 137: cmsclient.TopicCommentListData
	(*QueryTopicCommentListResp)(nil),                 // 138: cmsclient.QueryTopicCommentListResp
}
var file_rpc_cms_cms_proto_depIdxs = []int32{
	...
	111, // 7: cmsclient.QueryTopicListResp.list:type_name -> cmsclient.TopicListData
	124, // 8: cmsclient.QueryTopicCategoryListResp.list:type_name -> cmsclient.TopicCategoryListData
	137, // 9: cmsclient.QueryTopicCommentListResp.list:type_name -> cmsclient.TopicCommentListData
	...
	108, // 61: cmsclient.TopicService.QueryTopicDetail:input_type -> cmsclient.QueryTopicDetailReq
	110, // 62: cmsclient.TopicService.QueryTopicList:input_type -> cmsclient.QueryTopicListReq
	113, // 63: cmsclient.TopicCategoryService.AddTopicCategory:input_type -> cmsclient.AddTopicCategoryReq
	115, // 64: cmsclient.TopicCategoryService.DeleteTopicCategory:input_type -> cmsclient.DeleteTopicCategoryReq
	117, // 65: cmsclient.TopicCategoryService.UpdateTopicCategory:input_type -> cmsclient.UpdateTopicCategoryReq
	119, // 66: cmsclient.TopicCategoryService.UpdateTopicCategoryStatus:input_type -> cmsclient.UpdateTopicCategoryStatusReq
	121, // 67: cmsclient.TopicCategoryService.QueryTopicCategoryDetail:input_type -> cmsclient.QueryTopicCategoryDetailReq
	123, // 68: cmsclient.TopicCategoryService.QueryTopicCategoryList:input_type -> cmsclient.QueryTopicCategoryListReq
	126, // 69: cmsclient.TopicCommentService.AddTopicComment:input_type -> cmsclient.AddTopicCommentReq
	128, // 70: cmsclient.TopicCommentService.DeleteTopicComment:input_type -> cmsclient.DeleteTopicCommentReq
	130, // 71: cmsclient.TopicCommentService.UpdateTopicComment:input_type -> cmsclient.UpdateTopicCommentReq
	132, // 72: cmsclient.TopicCommentService.UpdateTopicCommentStatus:input_type -> cmsclient.UpdateTopicCommentStatusReq
	134, // 73: cmsclient.TopicCommentService.QueryTopicCommentDetail:input_type -> cmsclient.QueryTopicCommentDetailReq
	136, // 74: cmsclient.TopicCommentService.QueryTopicCommentList:input_type -> cmsclient.QueryTopicCommentListReq
	1,   // 75: cmsclient.HelpService.AddHelp:output_type -> cmsclient.AddHelpResp
	3,   // 76: cmsclient.HelpService.DeleteHelp:output_type -> cmsclient.DeleteHelpResp
	5,   // 77: cmsclient.HelpService.UpdateHelp:output_type -> cmsclient.UpdateHelpResp
	7,   // 78: cmsclient.HelpService.UpdateHelpStatus:output_type -> cmsclient.UpdateHelpStatusResp
	9,   // 79: cmsclient.HelpService.QueryHelpDetail:output_type -> cmsclient.QueryHelpDetailResp
	12,  // 80: cmsclient.HelpService.QueryHelpList:output_type -> cmsclient.QueryHelpListResp
	14,  // 81: cmsclient.HelpCategoryService.AddHelpCategory:output_type -> cmsclient.AddHelpCategoryResp
	16,  // 82: cmsclient.HelpCategoryService.DeleteHelpCategory:output_type -> cmsclient.DeleteHelpCategoryResp
	18,  // 83: cmsclient.HelpCategoryService.UpdateHelpCategory:output_type -> cmsclient.UpdateHelpCategoryResp
	20,  // 84: cmsclient.HelpCategoryService.UpdateHelpCategoryStatus:output_type -> cmsclient.UpdateHelpCategoryStatusResp
	22,  // 85: cmsclient.HelpCategoryService.QueryHelpCategoryDetail:output_type -> cmsclient.QueryHelpCategoryDetailResp
	25,  // 86: cmsclient.HelpCategoryService.QueryHelpCategoryList:output_type -> cmsclient.QueryHelpCategoryListResp
	27,  // 87: cmsclient.MemberReportService.AddMemberReport:output_type -> cmsclient.AddMemberReportResp
	29,  // 88: cmsclient.MemberReportService.DeleteMemberReport:output_type -> cmsclient.DeleteMemberReportResp
	31,  // 89: cmsclient.MemberReportService.UpdateMemberReport:output_type -> cmsclient.UpdateMemberReportResp
	33,  // 90: cmsclient.MemberReportService.UpdateMemberReportStatus:output_type -> cmsclient.UpdateMemberReportStatusResp
	35,  // 91: cmsclient.MemberReportService.QueryMemberReportDetail:output_type -> cmsclient.QueryMemberReportDetailResp
	38,  // 92: cmsclient.MemberReportService.QueryMemberReportList:output_type -> cmsclient.QueryMemberReportListResp
	40,  // 93: cmsclient.PreferredAreaService.AddPreferredArea:output_type -> cmsclient.AddPreferredAreaResp
	42,  // 94: cmsclient.PreferredAreaService.DeletePreferredArea:output_type -> cmsclient.DeletePreferredAreaResp
	44,  // 95: cmsclient.PreferredAreaService.UpdatePreferredArea:output_type -> cmsclient.UpdatePreferredAreaResp
	46,  // 96: cmsclient.PreferredAreaService.UpdatePreferredAreaStatus:output_type -> cmsclient.UpdatePreferredAreaStatusResp
	48,  // 97: cmsclient.PreferredAreaService.QueryPreferredAreaDetail:output_type -> cmsclient.QueryPreferredAreaDetailResp
	51,  // 98: cmsclient.PreferredAreaService.QueryPreferredAreaList:output_type -> cmsclient.QueryPreferredAreaListResp
	53,  // 99: cmsclient.PreferredAreaProductRelationService.AddPreferredAreaProductRelation:output_type -> cmsclient.AddPreferredAreaProductRelationResp
	55,  // 100: cmsclient.PreferredAreaProductRelationService.QueryPreferredAreaProductRelationList:output_type -> cmsclient.QueryPreferredAreaProductRelationListResp
	57,  // 101: cmsclient.SubjectService.AddSubject:output_type -> cmsclient.AddSubjectResp
	59,  // 102: cmsclient.SubjectService.DeleteSubject:output_type -> cmsclient.DeleteSubjectResp
	61,  // 103: cmsclient.SubjectService.UpdateSubject:output_type -> cmsclient.UpdateSubjectResp
	63,  // 104: cmsclient.SubjectService.UpdateSubjectStatus:output_type -> cmsclient.UpdateSubjectStatusResp
	65,  // 105: cmsclient.SubjectService.QuerySubjectDetail:output_type -> cmsclient.QuerySubjectDetailResp
	68,  // 106: cmsclient.SubjectService.QuerySubjectList:output_type -> cmsclient.QuerySubjectListResp
	68,  // 107: cmsclient.SubjectService.SubjectListByIds:output_type -> cmsclient.QuerySubjectListResp
	70,  // 108: cmsclient.SubjectService.UpdateSubjectRecommendStatus:output_type -> cmsclient.UpdateSubjectRecommendStatusResp
	73,  // 109: cmsclient.SubjectCategoryService.AddSubjectCategory:output_type -> cmsclient.AddSubjectCategoryResp
	75,  // 110: cmsclient.SubjectCategoryService.DeleteSubjectCategory:output_type -> cmsclient.DeleteSubjectCategoryResp
	77,  // 111: cmsclient.SubjectCategoryService.UpdateSubjectCategory:output_type -> cmsclient.UpdateSubjectCategoryResp
	79,  // 112: cmsclient.SubjectCategoryService.UpdateSubjectCategoryStatus:output_type -> cmsclient.UpdateSubjectCategoryStatusResp
	81,  // 113: cmsclient.SubjectCategoryService.QuerySubjectCategoryDetail:output_type -> cmsclient.QuerySubjectCategoryDetailResp
	84,  // 114: cmsclient.SubjectCategoryService.QuerySubjectCategoryList:output_type -> cmsclient.QuerySubjectCategoryListResp
	86,  // 115: cmsclient.SubjectCommentService.AddSubjectComment:output_type -> cmsclient.AddSubjectCommentResp
	88,  // 116: cmsclient.SubjectCommentService.DeleteSubjectComment:output_type -> cmsclient.DeleteSubjectCommentResp
	90,  // 117: cmsclient.SubjectCommentService.UpdateSubjectComment:output_type -> cmsclient.UpdateSubjectCommentResp
	92,  // 118: cmsclient.SubjectCommentService.UpdateSubjectCommentStatus:output_type -> cmsclient.UpdateSubjectCommentStatusResp
	94,  // 119: cmsclient.SubjectCommentService.QuerySubjectCommentDetail:output_type -> cmsclient.QuerySubjectCommentDetailResp
	97,  // 120: cmsclient.SubjectCommentService.QuerySubjectCommentList:output_type -> cmsclient.QuerySubjectCommentListResp
	99,  // 121: cmsclient.SubjectProductRelationService.AddSubjectProductRelation:output_type -> cmsclient.AddSubjectProductRelationResp
	101, // 122: cmsclient.SubjectProductRelationService.QuerySubjectProductRelationList:output_type -> cmsclient.QuerySubjectProductRelationListResp
	103, // 123: cmsclient.TopicService.AddTopic:output_type -> cmsclient.AddTopicResp
	105, // 124: cmsclient.TopicService.DeleteTopic:output_type -> cmsclient.DeleteTopicResp
	107, // 125: cmsclient.TopicService.UpdateTopic:output_type -> cmsclient.UpdateTopicResp
	109, // 126: cmsclient.TopicService.QueryTopicDetail:output_type -> cmsclient.QueryTopicDetailResp
	112, // 127: cmsclient.TopicService.QueryTopicList:output_type -> cmsclient.QueryTopicListResp
	114, // 128: cmsclient.TopicCategoryService.AddTopicCategory:output_type -> cmsclient.AddTopicCategoryResp
	116, // 129: cmsclient.TopicCategoryService.DeleteTopicCategory:output_type -> cmsclient.DeleteTopicCategoryResp
	118, // 130: cmsclient.TopicCategoryService.UpdateTopicCategory:output_type -> cmsclient.UpdateTopicCategoryResp
	120, // 131: cmsclient.TopicCategoryService.UpdateTopicCategoryStatus:output_type -> cmsclient.UpdateTopicCategoryStatusResp
	122, // 132: cmsclient.TopicCategoryService.QueryTopicCategoryDetail:output_type -> cmsclient.QueryTopicCategoryDetailResp
	125, // 133: cmsclient.TopicCategoryService.QueryTopicCategoryList:output_type -> cmsclient.QueryTopicCategoryListResp
	127, // 134: cmsclient.TopicCommentService.AddTopicComment:output_type -> cmsclient.AddTopicCommentResp
	129, // 135: cmsclient.TopicCommentService.DeleteTopicComment:output_type -> cmsclient.DeleteTopicCommentResp
	131, // 136: cmsclient.TopicCommentService.UpdateTopicComment:output_type -> cmsclient.UpdateTopicCommentResp
	133, // 137: cmsclient.TopicCommentService.UpdateTopicCommentStatus:output_type -> cmsclient.UpdateTopicCommentStatusResp
	135, // 138: cmsclient.TopicCommentService.QueryTopicCommentDetail:output_type -> cmsclient.QueryTopicCommentDetailResp
	138, // 139: cmsclient.TopicCommentService.QueryTopicCommentList:output_type -> cmsclient.QueryTopicCommentListResp
	75,  // [75:140] is the sub-list for method output_type
	10,  // [10:75] is the sub-list for method input_type
