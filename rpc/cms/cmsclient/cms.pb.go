...
func (x *QueryPreferredAreaListReq) GetPageNum() int32 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QueryPreferredAreaListReq) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type QuerySubjectListReq struct {
	...
	PageNum         int32  `protobuf:"varint,15,opt,name=page_num,json=pageNum,proto3" json:"page_num,omitempty"`                        //第几页
	PageSize        int32  `protobuf:"varint,16,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`                     //每页的数量
}
...
func (x *QuerySubjectListReq) GetPageNum() int32 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *QuerySubjectListReq) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
var file_rpc_cms_cms_proto_rawDesc = []byte{
	...
	0x6d, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x70, 0x61, 0x67, 0x65, 0x4e, 0x75, 0x6d,
	0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x10, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xe5, 0x04,
