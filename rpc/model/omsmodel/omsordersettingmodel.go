...
func (m *customOmsOrderSettingModel) FindAll(ctx context.Context, Current int64, PageSize int64) (*[]OmsOrderSetting, error) {
...
func (m *customOmsOrderSettingModel) Count(ctx context.Context) (int64, error) {
...
func (m *customOmsOrderSettingModel) DeleteByIds(ctx context.Context, ids []int64) error {
	// 拼接占位符 "?"
