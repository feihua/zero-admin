...
func NewOmsOrderReturnReasonModel(conn sqlx.SqlConn, c cache.CacheConf) OmsOrderReturnReasonModel {
	return &customOmsOrderReturnReasonModel{
		defaultOmsOrderReturnReasonModel: newOmsOrderReturnReasonModel(conn, c),
	}
}
