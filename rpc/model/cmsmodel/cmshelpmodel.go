...
type (
	...
	CmsHelpModel interface {
		...
		FindAll(ctx context.Context, Current int64, PageSize int64) (*[]CmsHelp, error)
...
func (m *customCmsHelpModel) FindAll(ctx context.Context, Current int64, PageSize int64) (*[]CmsHelp, error) {

	query := fmt.Sprintf("select %s from %s limit ?,?", cmsHelpRows, m.table)
	var resp []CmsHelp
...
func (m *customCmsHelpModel) Count(ctx context.Context) (int64, error) {
...
func (m *customCmsHelpModel) DeleteByIds(ctx context.Context, ids []int64) error {
	// 拼接占位符 "?"
