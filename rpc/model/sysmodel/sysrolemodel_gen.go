...
func (m *defaultSysRoleModel) Insert(ctx context.Context, data *SysRole) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.Name, data.Remark, data.CreateBy, data.UpdateBy, data.DelFlag, data.Status)
	return ret, err
}
...
func (m *defaultSysRoleModel) Update(ctx context.Context, data *SysRole) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.Name, data.Remark, data.CreateBy, data.UpdateBy, data.DelFlag, data.Status, data.Id)
	return err
}
