...
func (m *defaultSysUserRoleModel) Insert(ctx context.Context, data *SysUserRole) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.UserId, data.RoleId, data.CreateBy, data.LastUpdateBy, data.LastUpdateTime)
	return ret, err
}
...
func (m *defaultSysUserRoleModel) Update(ctx context.Context, data *SysUserRole) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.UserId, data.RoleId, data.CreateBy, data.LastUpdateBy, data.LastUpdateTime, data.Id)
	return err
}
