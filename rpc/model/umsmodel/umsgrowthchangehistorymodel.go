...
func (m *customUmsGrowthChangeHistoryModel) FindAll(ctx context.Context, Current int64, PageSize int64) (*[]UmsGrowthChangeHistory, error) {
...
func (m *customUmsGrowthChangeHistoryModel) Count(ctx context.Context) (int64, error) {
...
func (m *customUmsGrowthChangeHistoryModel) DeleteByIds(ctx context.Context, ids []int64) error {
