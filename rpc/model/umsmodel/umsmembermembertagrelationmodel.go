...
func (m *customUmsMemberMemberTagRelationModel) FindAll(ctx context.Context, Current int64, PageSize int64) (*[]UmsMemberMemberTagRelation, error) {
...
func (m *customUmsMemberMemberTagRelationModel) Count(ctx context.Context) (int64, error) {
...
func (m *customUmsMemberMemberTagRelationModel) DeleteByIds(ctx context.Context, ids []int64) error {
	// 拼接占位符 "?"
