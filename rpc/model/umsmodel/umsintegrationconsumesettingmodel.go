...
func (m *customUmsIntegrationConsumeSettingModel) FindAll(ctx context.Context, Current int64, PageSize int64) (*[]UmsIntegrationConsumeSetting, error) {
...
func (m *customUmsIntegrationConsumeSettingModel) Count(ctx context.Context) (int64, error) {
...
func (m *customUmsIntegrationConsumeSettingModel) DeleteByIds(ctx context.Context, ids []int64) error {
