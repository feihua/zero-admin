...
var (
	...
	umsIntegrationChangeHistoryRowsExpectAutoSet   = strings.Join(stringx.Remove(umsIntegrationChangeHistoryFieldNames, "`id`", "`create_time`", "`update_time`", "`create_at`", "`update_at`"), ",")
	umsIntegrationChangeHistoryRowsWithPlaceHolder = strings.Join(stringx.Remove(umsIntegrationChangeHistoryFieldNames, "`id`", "`create_time`", "`update_time`", "`create_at`", "`update_at`"), "=?,") + "=?"
)
