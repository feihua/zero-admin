...
var (
	...
	umsMemberProductCategoryRelationRowsExpectAutoSet   = strings.Join(stringx.Remove(umsMemberProductCategoryRelationFieldNames, "`id`", "`create_time`", "`update_time`", "`create_at`", "`update_at`"), ",")
	umsMemberProductCategoryRelationRowsWithPlaceHolder = strings.Join(stringx.Remove(umsMemberProductCategoryRelationFieldNames, "`id`", "`create_time`", "`update_time`", "`create_at`", "`update_at`"), "=?,") + "=?"
)
