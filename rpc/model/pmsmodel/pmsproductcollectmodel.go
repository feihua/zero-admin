...
func NewPmsProductCollectModel(conn sqlx.SqlConn, c cache.CacheConf) PmsProductCollectModel {
	return &customPmsProductCollectModel{
		defaultPmsProductCollectModel: newPmsProductCollectModel(conn, c),
	}
}
