...
func NewPmsProductFullReductionModel(conn sqlx.SqlConn, c cache.CacheConf) PmsProductFullReductionModel {
	return &customPmsProductFullReductionModel{
		defaultPmsProductFullReductionModel: newPmsProductFullReductionModel(conn, c),
	}
}
