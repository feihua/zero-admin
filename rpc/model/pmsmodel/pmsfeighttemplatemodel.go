...
func NewPmsFeightTemplateModel(conn sqlx.SqlConn) PmsFeightTemplateModel {
	return &customPmsFeightTemplateModel{
		defaultPmsFeightTemplateModel: newPmsFeightTemplateModel(conn),
	}
}

func (m *customPmsFeightTemplateModel) FindAll(ctx context.Context, Current int64, PageSize int64) (*[]PmsFeightTemplate, error) {
...
func (m *customPmsFeightTemplateModel) Count(ctx context.Context) (int64, error) {
...
func (m *customPmsFeightTemplateModel) DeleteByIds(ctx context.Context, ids []int64) error {
	// 拼接占位符 "?"
