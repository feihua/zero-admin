...
func NewPmsProductOperateLogModel(conn sqlx.SqlConn, c cache.CacheConf) PmsProductOperateLogModel {
	return &customPmsProductOperateLogModel{
		defaultPmsProductOperateLogModel: newPmsProductOperateLogModel(conn, c),
	}
}
