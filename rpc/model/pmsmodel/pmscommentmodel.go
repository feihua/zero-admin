...
func (m *customPmsCommentModel) FindAll(ctx context.Context, Current int64, PageSize int64) (*[]PmsComment, error) {
...
func (m *customPmsCommentModel) Count(ctx context.Context) (int64, error) {
...
func (m *customPmsCommentModel) DeleteByIds(ctx context.Context, ids []int64) error {
	// 拼接占位符 "?"
