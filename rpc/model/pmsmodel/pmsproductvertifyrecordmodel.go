...
func NewPmsProductVertifyRecordModel(conn sqlx.SqlConn, c cache.CacheConf) PmsProductVertifyRecordModel {
	return &customPmsProductVertifyRecordModel{
		defaultPmsProductVertifyRecordModel: newPmsProductVertifyRecordModel(conn, c),
	}
}
