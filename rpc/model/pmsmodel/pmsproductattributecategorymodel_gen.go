...
var (
	...
	pmsProductAttributeCategoryRowsExpectAutoSet   = strings.Join(stringx.Remove(pmsProductAttributeCategoryFieldNames, "`id`", "`create_time`", "`update_time`", "`create_at`", "`update_at`"), ",")
	pmsProductAttributeCategoryRowsWithPlaceHolder = strings.Join(stringx.Remove(pmsProductAttributeCategoryFieldNames, "`id`", "`create_time`", "`update_time`", "`create_at`", "`update_at`"), "=?,") + "=?"
)
