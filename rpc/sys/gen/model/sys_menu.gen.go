...
type SysMenu struct {
	...
	VuePath       *string    `gorm:"column:vue_path;comment:vue系统的path" json:"vue_path"`                           // vue系统的path
	VueComponent  *string    `gorm:"column:vue_component;comment:vue的页面" json:"vue_component"`                     // vue的页面
	VueIcon       *string    `gorm:"column:vue_icon;comment:vue的图标" json:"vue_icon"`                               // vue的图标
	VueRedirect   *string    `gorm:"column:vue_redirect;comment:vue的路由重定向" json:"vue_redirect"`                    // vue的路由重定向
