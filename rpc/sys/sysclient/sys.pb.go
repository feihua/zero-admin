...
type QueryLoginLogDetailResp struct {
	...
	Extra     string `protobuf:"bytes,4,opt,name=extra,proto3" json:"extra,omitempty"`                          //其他信息（可选）
	Status    int32  `protobuf:"varint,5,opt,name=status,proto3" json:"status,omitempty"`                       //登录状态(0:失败,1:成功)
	Msg       string `protobuf:"bytes,6,opt,name=msg,proto3" json:"msg,omitempty"`                              //提示消息
	LoginTime string `protobuf:"bytes,7,opt,name=login_time,json=loginTime,proto3" json:"login_time,omitempty"` //访问时间
}
...
type QueryLoginLogListReq struct {
	...
	Status    int32  `protobuf:"varint,3,opt,name=status,proto3" json:"status,omitempty"`                       //登录状态(0:失败,1:成功)
	PageNum   int64  `protobuf:"varint,4,opt,name=page_num,json=pageNum,proto3" json:"page_num,omitempty"`      //第几页
	PageSize  int64  `protobuf:"varint,5,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`   //每页的数量
}
...
type AddMenuReq struct {
	...
	MenuName     string `protobuf:"bytes,1,opt,name=menu_name,json=menuName,proto3" json:"menu_name,omitempty"`              //菜单名称
	Ancestors    string `protobuf:"bytes,2,opt,name=ancestors,proto3" json:"ancestors,omitempty"`                            //祖级列表
	MenuType     int32  `protobuf:"varint,3,opt,name=menu_type,json=menuType,proto3" json:"menu_type,omitempty"`             //菜单类型(1:目录,2:菜单,3:按钮)
	MenuUrl      string `protobuf:"bytes,4,opt,name=menu_url,json=menuUrl,proto3" json:"menu_url,omitempty"`                 //路由路径
	MenuIcon     string `protobuf:"bytes,5,opt,name=menu_icon,json=menuIcon,proto3" json:"menu_icon,omitempty"`              //菜单图标
	MenuSort     int32  `protobuf:"varint,6,opt,name=menu_sort,json=menuSort,proto3" json:"menu_sort,omitempty"`             //排序
	ParentId     int64  `protobuf:"varint,7,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty"`             //父id
	ApiUrl       string `protobuf:"bytes,8,opt,name=api_url,json=apiUrl,proto3" json:"api_url,omitempty"`                    //接口url
	Visible      int32  `protobuf:"varint,9,opt,name=visible,proto3" json:"visible,omitempty"`                               //显示状态（0:隐藏,显示:1）
	Status       int32  `protobuf:"varint,10,opt,name=status,proto3" json:"status,omitempty"`                                //菜单状态(1:正常，0:禁用)
	Remark       string `protobuf:"bytes,11,opt,name=remark,proto3" json:"remark,omitempty"`                                 //备注
	VuePath      string `protobuf:"bytes,12,opt,name=vue_path,json=vuePath,proto3" json:"vue_path,omitempty"`                //vue的path
	VueComponent string `protobuf:"bytes,13,opt,name=vue_component,json=vueComponent,proto3" json:"vue_component,omitempty"` //vue的页面
	VueIcon      string `protobuf:"bytes,14,opt,name=vue_icon,json=vueIcon,proto3" json:"vue_icon,omitempty"`                //vue的图标
	VueRedirect  string `protobuf:"bytes,15,opt,name=vue_redirect,json=vueRedirect,proto3" json:"vue_redirect,omitempty"`    //vue的路由重定向
	AngularIcon  string `protobuf:"bytes,16,opt,name=angular_icon,json=angularIcon,proto3" json:"angular_icon,omitempty"`    //angular的图标
	ReactIcon    string `protobuf:"bytes,17,opt,name=react_icon,json=reactIcon,proto3" json:"react_icon,omitempty"`          //antd react的图标
...
func (x *AddMenuReq) GetAncestors() string {
	if x != nil {
		return x.Ancestors
	}
	return ""
...
func (x *AddMenuReq) GetAngularIcon() string {
	if x != nil {
		return x.AngularIcon
	}
	return ""
}

func (x *AddMenuReq) GetReactIcon() string {
	if x != nil {
		return x.ReactIcon
	}
	return ""
...
type UpdateMenuReq struct {
	...
	Ancestors    string `protobuf:"bytes,3,opt,name=ancestors,proto3" json:"ancestors,omitempty"`                            //祖级列表
	MenuType     int32  `protobuf:"varint,4,opt,name=menu_type,json=menuType,proto3" json:"menu_type,omitempty"`             //菜单类型(1:目录,2:菜单,3:按钮)
	MenuUrl      string `protobuf:"bytes,5,opt,name=menu_url,json=menuUrl,proto3" json:"menu_url,omitempty"`                 //路由路径
	MenuIcon     string `protobuf:"bytes,6,opt,name=menu_icon,json=menuIcon,proto3" json:"menu_icon,omitempty"`              //菜单图标
	MenuSort     int32  `protobuf:"varint,7,opt,name=menu_sort,json=menuSort,proto3" json:"menu_sort,omitempty"`             //排序
	ParentId     int64  `protobuf:"varint,8,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty"`             //父id
	ApiUrl       string `protobuf:"bytes,9,opt,name=api_url,json=apiUrl,proto3" json:"api_url,omitempty"`                    //接口url
	Visible      int32  `protobuf:"varint,10,opt,name=visible,proto3" json:"visible,omitempty"`                              //显示状态（0:隐藏,显示:1）
	Status       int32  `protobuf:"varint,11,opt,name=status,proto3" json:"status,omitempty"`                                //菜单状态(1:正常，0:禁用)
	Remark       string `protobuf:"bytes,12,opt,name=remark,proto3" json:"remark,omitempty"`                                 //备注
	VuePath      string `protobuf:"bytes,13,opt,name=vue_path,json=vuePath,proto3" json:"vue_path,omitempty"`                //vue的path
	VueComponent string `protobuf:"bytes,14,opt,name=vue_component,json=vueComponent,proto3" json:"vue_component,omitempty"` //vue的页面
	VueIcon      string `protobuf:"bytes,15,opt,name=vue_icon,json=vueIcon,proto3" json:"vue_icon,omitempty"`                //vue的图标
	VueRedirect  string `protobuf:"bytes,16,opt,name=vue_redirect,json=vueRedirect,proto3" json:"vue_redirect,omitempty"`    //vue的路由重定向
	AngularIcon  string `protobuf:"bytes,17,opt,name=angular_icon,json=angularIcon,proto3" json:"angular_icon,omitempty"`    //angular的图标
	ReactIcon    string `protobuf:"bytes,18,opt,name=react_icon,json=reactIcon,proto3" json:"react_icon,omitempty"`          //antd react的图标
	UpdateBy     string `protobuf:"bytes,19,opt,name=update_by,json=updateBy,proto3" json:"update_by,omitempty"`             //更新者
}
...
func (x *UpdateMenuReq) GetAncestors() string {
	if x != nil {
		return x.Ancestors
	}
	return ""
...
func (x *UpdateMenuReq) GetAngularIcon() string {
	if x != nil {
		return x.AngularIcon
	}
	return ""
...
func (x *UpdateMenuReq) GetReactIcon() string {
	if x != nil {
		return x.ReactIcon
	}
	return ""
...
type QueryMenuDetailResp struct {
	...
	Visible      int32  `protobuf:"varint,10,opt,name=visible,proto3" json:"visible,omitempty"`                              //显示状态（0:隐藏,显示:1）
	Status       int32  `protobuf:"varint,11,opt,name=status,proto3" json:"status,omitempty"`                                //菜单状态(1:正常，0:禁用)
	DelFlag      int32  `protobuf:"varint,12,opt,name=del_flag,json=delFlag,proto3" json:"del_flag,omitempty"`               //删除标志（0:删除,1:存在）
	Remark       string `protobuf:"bytes,13,opt,name=remark,proto3" json:"remark,omitempty"`                                 //备注
	VuePath      string `protobuf:"bytes,14,opt,name=vue_path,json=vuePath,proto3" json:"vue_path,omitempty"`                //vue的path
	...
	VueRedirect  string `protobuf:"bytes,17,opt,name=vue_redirect,json=vueRedirect,proto3" json:"vue_redirect,omitempty"`    //vue的路由重定向
	AngularIcon  string `protobuf:"bytes,18,opt,name=angular_icon,json=angularIcon,proto3" json:"angular_icon,omitempty"`    //angular的图标
	ReactIcon    string `protobuf:"bytes,19,opt,name=react_icon,json=reactIcon,proto3" json:"react_icon,omitempty"`          //antd react的图标
	CreateBy     string `protobuf:"bytes,20,opt,name=create_by,json=createBy,proto3" json:"create_by,omitempty"`             //创建者
	CreateTime   string `protobuf:"bytes,21,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`       //创建时间
	UpdateBy     string `protobuf:"bytes,22,opt,name=update_by,json=updateBy,proto3" json:"update_by,omitempty"`             //更新者
...
func (x *QueryMenuDetailResp) GetAncestors() string {
	if x != nil {
		return x.Ancestors
	}
	return ""
...
func (x *QueryMenuDetailResp) GetDelFlag() int32 {
	if x != nil {
		return x.DelFlag
	}
	return 0
...
func (x *QueryMenuDetailResp) GetAngularIcon() string {
	if x != nil {
		return x.AngularIcon
	}
	return ""
...
func (x *QueryMenuDetailResp) GetReactIcon() string {
	if x != nil {
		return x.ReactIcon
	}
	return ""
...
func (x *MenuListData) GetAncestors() string {
	if x != nil {
		return x.Ancestors
	}
	return ""
...
func (x *MenuListData) GetVisible() int32 {
	if x != nil {
		return x.Visible
	}
	return 0
...
func (x *MenuListData) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *MenuListData) GetAngularIcon() string {
	if x != nil {
		return x.AngularIcon
	}
	return ""
...
func (x *MenuListData) GetReactIcon() string {
	if x != nil {
		return x.ReactIcon
	}
	return ""
...
type AddOperateLogReq struct {
	...
	OperateName  string `protobuf:"bytes,2,opt,name=operate_name,json=operateName,proto3" json:"operate_name,omitempty"`    //操作人员
	OperateUrl   string `protobuf:"bytes,3,opt,name=operate_url,json=operateUrl,proto3" json:"operate_url,omitempty"`       //请求URL
	OperateIp    string `protobuf:"bytes,4,opt,name=operate_ip,json=operateIp,proto3" json:"operate_ip,omitempty"`          //主机地址
	OperateParam string `protobuf:"bytes,5,opt,name=operate_param,json=operateParam,proto3" json:"operate_param,omitempty"` //请求参数
	JsonResult   string `protobuf:"bytes,6,opt,name=json_result,json=jsonResult,proto3" json:"json_result,omitempty"`       //返回参数
	Extra        string `protobuf:"bytes,7,opt,name=extra,proto3" json:"extra,omitempty"`                                   //其他信息（可选）
	Status       int32  `protobuf:"varint,8,opt,name=status,proto3" json:"status,omitempty"`                                // 操作状态(0:异常,正常)
	OperateTime  string `protobuf:"bytes,9,opt,name=operate_time,json=operateTime,proto3" json:"operate_time,omitempty"`    // 操作时间
	CostTime     int64  `protobuf:"varint,10,opt,name=cost_time,json=costTime,proto3" json:"cost_time,omitempty"`           // 消耗时间
}
...
func (x *QueryOperateLogListReq) GetOperateParam() string {
	if x != nil {
		return x.OperateParam
	}
	return ""
...
func (x *QueryOperateLogListReq) GetJsonResult() string {
	if x != nil {
		return x.JsonResult
	}
	return ""
...
type UserData struct {
	...
	LastLoginInfo string `protobuf:"bytes,11,opt,name=last_login_info,json=lastLoginInfo,proto3" json:"last_login_info,omitempty"` //最后登录信息
...
func (x *UserData) GetLastLoginInfo() string {
	if x != nil {
...
func (x *QueryUserDetailResp) GetLastLoginInfo() string {
	if x != nil {
		return x.LastLoginInfo
	}
	return ""
...
type QueryUserListReq struct {
	...
	PageNum  int64  `protobuf:"varint,10,opt,name=page_num,json=pageNum,proto3" json:"page_num,omitempty"`    //第几页
	PageSize int64  `protobuf:"varint,11,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"` //每页的数量
}
...
func (x *UserListData) GetLastLoginInfo() string {
	if x != nil {
		return x.LastLoginInfo
	}
	return ""
...
type MenuListTree struct {
	...
	ReactIcon    string `protobuf:"bytes,10,opt,name=react_icon,json=reactIcon,proto3" json:"react_icon,omitempty"`
	AngularIcon  string `protobuf:"bytes,11,opt,name=angular_icon,json=angularIcon,proto3" json:"angular_icon,omitempty"`
}
...
func (x *MenuListTree) GetReactIcon() string {
	if x != nil {
		return x.ReactIcon
	}
	return ""
...
func (x *MenuListTree) GetAngularIcon() string {
	if x != nil {
		return x.AngularIcon
	}
	return ""
...
var file_rpc_sys_sys_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x03, 0x73, 0x79, 0x73, 0x22, 0xfb, 0x01, 0x0a, 0x0a, 0x41, 0x64, 0x64,
	...
	0x6e, 0x74, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x65, 0x70, 0x74, 0x5f, 0x6e, 0x61, 0x6d,
	...
	,
	...
	0x79, 0x22, 0x24, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x65, 0x70, 0x74, 0x52,
	0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0x5a, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x44, 0x65, 0x70, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x12, 0x0e,
	...
	0x65, 0x42, 0x79, 0x22, 0x2a, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x65, 0x70,
	0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70,
	0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22,
	0x24, 0x0a, 0x12, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44, 0x65, 0x70, 0x74, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x9c, 0x03, 0x0a, 0x13, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44,
	...
	0x54, 0x69, 0x6d, 0x65, 0x22, 0x12, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44, 0x65, 0x70,
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x22, 0x95, 0x03, 0x0a, 0x0c, 0x44, 0x65, 0x70,
	...
	0x74, 0x6f, 0x72, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x65, 0x70, 0x74, 0x5f, 0x6e, 0x61, 0x6d,
	...
	0x04, 0x73, 0x6f, 0x72, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x14, 0x0a,
	...
	0x73, 0x12, 0x19, 0x0a, 0x08, 0x64, 0x65, 0x6c, 0x5f, 0x66, 0x6c, 0x61, 0x67, 0x18, 0x0a, 0x20,
	...
	,
	...
	0x09, 0x64, 0x69, 0x63, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x69,
	0x63, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64,
	0x69, 0x63, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x73, 0x73, 0x5f, 0x63,
	0x6c, 0x61, 0x73, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x73, 0x73, 0x43,
	0x6c, 0x61, 0x73, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x63, 0x6c, 0x61,
	0x73, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6c, 0x69, 0x73, 0x74, 0x43, 0x6c,
	0x61, 0x73, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x73, 0x5f, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x22, 0x28, 0x0a,
	0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x69, 0x63, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x52,
	0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0x60, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x02, 0x69, 0x64, 0x22, 0xa8, 0x03, 0x0a, 0x17, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44, 0x69, 0x63,
	...
	0x01, 0x0a, 0x14, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44, 0x69, 0x63, 0x74, 0x49, 0x74, 0x65, 0x6d,
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x1d, 0x0a, 0x0a, 0x64, 0x69, 0x63, 0x74, 0x5f,
	0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x69, 0x63,
	0x74, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x69, 0x63, 0x74, 0x5f, 0x74,
	...
	0x69, 0x7a, 0x65, 0x18, 0x3b, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53,
	0x69, 0x7a, 0x65, 0x22, 0xa1, 0x03, 0x0a, 0x10, 0x44, 0x69, 0x63, 0x74, 0x49, 0x74, 0x65, 0x6d,
	...
	0x5f, 0x73, 0x6f, 0x72, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x64, 0x69, 0x63,
	0x74, 0x53, 0x6f, 0x72, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x64, 0x69, 0x63, 0x74, 0x5f, 0x6c, 0x61,
	...
	0x12, 0x1b, 0x0a, 0x09, 0x63, 0x73, 0x73, 0x5f, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x73, 0x73, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x12, 0x1d, 0x0a,
	0x0a, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x6c, 0x69, 0x73, 0x74, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x12, 0x1d, 0x0a, 0x0a,
	0x69, 0x73, 0x5f, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09,
	...
	0x61, 0x74, 0x65, 0x5f, 0x62, 0x79, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x70,
	...
	0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x58, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x79, 0x73, 0x2e, 0x44, 0x69, 0x63, 0x74, 0x49,
	0x74, 0x65, 0x6d, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73,
	0x74, 0x22, 0xa7, 0x01, 0x0a, 0x0e, 0x41, 0x64, 0x64, 0x44, 0x69, 0x63, 0x74, 0x54, 0x79, 0x70,
	...
	0x64, 0x64, 0x44, 0x69, 0x63, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12,
	...
	,
	...
	0x22, 0x28, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x69, 0x63, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0x60, 0x0a, 0x17, 0x55, 0x70,
	...
	0x28, 0x09, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x22, 0x2e, 0x0a, 0x18,
	...
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x8f, 0x02, 0x0a, 0x17, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xa0, 0x01, 0x0a, 0x14, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x44, 0x69, 0x63, 0x74, 0x54, 0x79, 0x70, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
	0x71, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x69, 0x63, 0x74, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x69, 0x63, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1b,
	...
	0x03, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x88, 0x02, 0x0a, 0x10,
	...
	0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x58, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44,
	...
	0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x79, 0x73, 0x2e, 0x44, 0x69, 0x63, 0x74, 0x54, 0x79,
	0x70, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74,
	0x22, 0x25, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x4c,
	...
	0x65, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a,
	0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e,
	0x67, 0x22, 0x28, 0x0a, 0x16, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x4c,
	0x6f, 0x67, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xbf, 0x01, 0x0a, 0x17,
	0x51, 0x75, 0x65, 0x72, 0x79, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x4c, 0x6f, 0x67, 0x44, 0x65, 0x74,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x69, 0x70, 0x61, 0x64, 0x64, 0x72, 0x12, 0x16, 0x0a,
	...
	0x65, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x70, 0x61, 0x64, 0x64, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x69, 0x70, 0x61, 0x64, 0x64, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x78, 0x74,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x12, 0x1d, 0x0a, 0x0a, 0x6c, 0x6f, 0x67,
	0x69, 0x6e, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6c,
	0x6f, 0x67, 0x69, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x58, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x4c, 0x6f, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73,
	...
	,
	...
	,
	...
	0x73, 0x22, 0x24, 0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x65, 0x6e, 0x75, 0x52,
	0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0xa9, 0x04, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61,
	...
	0x6e, 0x75, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x74,
	0x6f, 0x72, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x6e, 0x63, 0x65, 0x73,
	0x74, 0x6f, 0x72, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6e, 0x75, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x6d, 0x65, 0x6e, 0x75, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x19, 0x0a, 0x08, 0x6d, 0x65, 0x6e, 0x75, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x6e, 0x75, 0x55, 0x72, 0x6c, 0x12, 0x1b, 0x0a, 0x09,
	...
	,
	...
	,
	...
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64,
	0x22, 0xa9, 0x05, 0x0a, 0x13, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4d, 0x65, 0x6e, 0x75, 0x44, 0x65,
	...
	0x75, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x74, 0x6f,
	...
	0x12, 0x19, 0x0a, 0x08, 0x6d, 0x65, 0x6e, 0x75, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x6e, 0x75, 0x55, 0x72, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x6d,
	...
	0x5f, 0x73, 0x6f, 0x72, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x6d, 0x65, 0x6e,
	0x75, 0x53, 0x6f, 0x72, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f,
	0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74,
	0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x70, 0x69, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x70, 0x69, 0x55, 0x72, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x76,
	0x69, 0x73, 0x69, 0x62, 0x6c, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x76, 0x69,
	...
	,
	...
	0x61, 0x74, 0x75, 0x73, 0x22, 0xa2, 0x05, 0x0a, 0x0c, 0x4d, 0x65, 0x6e, 0x75, 0x4c, 0x69, 0x73,
	...
	0x01, 0x28, 0x05, 0x52, 0x08, 0x6d, 0x65, 0x6e, 0x75, 0x54, 0x79, 0x70, 0x65, 0x12, 0x19, 0x0a,
	0x08, 0x6d, 0x65, 0x6e, 0x75, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x6d, 0x65, 0x6e, 0x75, 0x55, 0x72, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6e, 0x75,
	0x5f, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x65, 0x6e,
	0x75, 0x49, 0x63, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6e, 0x75, 0x5f, 0x73, 0x6f,
	0x72, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x6d, 0x65, 0x6e, 0x75, 0x53, 0x6f,
	...
	0x52, 0x06, 0x61, 0x70, 0x69, 0x55, 0x72, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x69, 0x73, 0x69,
	0x62, 0x6c, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x76, 0x69, 0x73, 0x69, 0x62,
	0x6c, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0b, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x64, 0x65,
	0x6c, 0x5f, 0x66, 0x6c, 0x61, 0x67, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x64, 0x65,
	...
	0x08, 0x76, 0x75, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	,
	...
	0x65, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x15, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x75,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x62, 0x79, 0x18, 0x16, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x75, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x17, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x75,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x50, 0x0a, 0x11, 0x51, 0x75, 0x65,
	...
	0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xc6, 0x01, 0x0a, 0x0c,
	0x41, 0x64, 0x64, 0x4e, 0x6f, 0x74, 0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x12, 0x21, 0x0a, 0x0c,
	...
	0x74, 0x65, 0x42, 0x79, 0x22, 0x23, 0x0a, 0x0d, 0x41, 0x64, 0x64, 0x4e, 0x6f, 0x74, 0x69, 0x63,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0x23, 0x0a, 0x0f, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03,
	...
	0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0xd9, 0x01, 0x0a, 0x0f, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x42, 0x79, 0x22, 0x26, 0x0a, 0x10, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x74, 0x69,
	0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0x5e, 0x0a, 0x15, 0x55, 0x70,
	...
	,
	...
	0xa8, 0x01, 0x0a, 0x12, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4e, 0x6f, 0x74, 0x69, 0x63, 0x65, 0x4c,
	...
	0x0a, 0x0c, 0x6e, 0x6f, 0x74, 0x69, 0x63, 0x65, 0x5f, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x03,
	...
	0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x59, 0x0a, 0x13, 0x51, 0x75,
	...
	0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x2c, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x73, 0x79, 0x73, 0x2e, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x4e, 0x6f, 0x74, 0x69, 0x63, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52,
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xbc, 0x02, 0x0a, 0x13, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4e,
	0x6f, 0x74, 0x69, 0x63, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e, 0x0a,
	...
	,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6a, 0x73, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x65, 0x54,
	0x69, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x73, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65,
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x63, 0x6f, 0x73, 0x74, 0x54, 0x69, 0x6d, 0x65,
	...
	,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6a, 0x73, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c,
	...
	,
	...
	,
	...
	0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x73, 0x79, 0x73, 0x2e,
	0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x65, 0x4c, 0x6f, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61,
	0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xb7, 0x01, 0x0a, 0x0a, 0x41, 0x64, 0x64,
	...
	0x42, 0x79, 0x22, 0x21, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73,
	...
	0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0xba,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a,
	0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e,
	0x67, 0x22, 0x5c, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x73, 0x74, 0x53,
	...
	0x2a, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x73, 0x74, 0x53, 0x74, 0x61,
	...
	0x69, 0x6d, 0x65, 0x22, 0x9c, 0x01, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x6f, 0x73,
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6f, 0x73, 0x74,
	0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x6f, 0x73,
	...
	0x7a, 0x65, 0x22, 0x98, 0x02, 0x0a, 0x0c, 0x50, 0x6f, 0x73, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x44,
	0x61, 0x74, 0x61, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x09, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x50, 0x0a,
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x73, 0x79, 0x73, 0x2e, 0x50, 0x6f, 0x73,
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22,
	0xdb, 0x01, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x52, 0x6f, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x12, 0x0e,
	...
	,
	...
	0x69, 0x64, 0x73, 0x22, 0x24, 0x0a, 0x0e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x6f, 0x6c,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0xde, 0x01, 0x0a, 0x0d, 0x55, 0x70,
	...
	0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x22, 0x24, 0x0a, 0x0e, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04,
	0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67,
	0x22, 0x5c, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6c, 0x65, 0x53, 0x74,
	...
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64,
	0x22, 0xc3, 0x02, 0x0a, 0x13, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x6f, 0x6c, 0x65, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	...
	0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xd4, 0x01, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79,
	0x52, 0x6f, 0x6c, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x1b, 0x0a, 0x09, 0x72,
	...
	0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x64, 0x65,
	0x6c, 0x5f, 0x66, 0x6c, 0x61, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x64, 0x65,
	0x6c, 0x46, 0x6c, 0x61, 0x67, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x6e, 0x75,
	0x6d, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x70, 0x61, 0x67, 0x65, 0x4e, 0x75, 0x6d,
	0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xbc, 0x02,
	...
	0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x50, 0x0a, 0x11,
	...
	0x0a, 0x14, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x6f, 0x6c, 0x65, 0x4d, 0x65, 0x6e, 0x75, 0x4c,
	0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a, 0x06, 0x52, 0x6f, 0x6c, 0x65, 0x49, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x52, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x22, 0xff,
	0x04, 0x0a, 0x08, 0x4d, 0x65, 0x6e, 0x75, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x22, 0x54, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x6f, 0x6c, 0x65, 0x4d, 0x65, 0x6e,
	0x75, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x21, 0x0a, 0x04, 0x6c, 0x69, 0x73,
	0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x73, 0x79, 0x73, 0x2e, 0x4d, 0x65,
	0x6e, 0x75, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07,
	0x4d, 0x65, 0x6e, 0x75, 0x49, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x03, 0x52, 0x07, 0x4d,
	0x65, 0x6e, 0x75, 0x49, 0x64, 0x73, 0x22, 0x45, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0xb7, 0x01, 0x0a, 0x14, 0x51, 0x75, 0x65, 0x72,
	...
	0x64, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x65, 0x78, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x07, 0x69, 0x73, 0x45, 0x78, 0x69, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06,
	...
	0x65, 0x22, 0x83, 0x04, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x16,
	...
	0x52, 0x06, 0x64, 0x65, 0x70, 0x74, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x6c, 0x61, 0x73, 0x74,
	0x5f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0b, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0d, 0x6c, 0x61, 0x73, 0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x50, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xa6, 0x04, 0x0a,
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6c, 0x61, 0x73,
	0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x26, 0x0a, 0x0f, 0x70, 0x77,
	...
	0x6f, 0x6c, 0x65, 0x49, 0x64, 0x73, 0x18, 0x17, 0x20, 0x03, 0x28, 0x03, 0x52, 0x07, 0x52, 0x6f,
	0x6c, 0x65, 0x49, 0x64, 0x73, 0x22, 0x80, 0x02, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55,
	0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x6f,
	...
	0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x64, 0x65, 0x70, 0x74, 0x49, 0x64,
	0x12, 0x19, 0x0a, 0x08, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x07, 0x70, 0x61, 0x67, 0x65, 0x4e, 0x75, 0x6d, 0x12, 0x1b, 0x0a, 0x09, 0x70,
	0x61, 0x67, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08,
	0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x85, 0x04, 0x0a, 0x0c, 0x55, 0x73, 0x65,
	...
	0x06, 0x64, 0x65, 0x70, 0x74, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x6c, 0x61, 0x73, 0x74, 0x5f,
	0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0d, 0x6c, 0x61, 0x73, 0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x50, 0x6f, 0x73, 0x74, 0x49, 0x64,
	0x73, 0x18, 0x16, 0x20, 0x03, 0x28, 0x03, 0x52, 0x07, 0x50, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x73,
	0x22, 0x50, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x01,
	...
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x62, 0x72, 0x6f, 0x77, 0x73, 0x65, 0x72, 0x22, 0x8e,
	0x01, 0x0a, 0x09, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x55, 0x72, 0x6c, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x61, 0x64, 0x6d, 0x69, 0x6e,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x22,
	...
	0x49, 0x64, 0x22, 0xb7, 0x02, 0x0a, 0x0c, 0x4d, 0x65, 0x6e, 0x75, 0x4c, 0x69, 0x73, 0x74, 0x54,
	...
	0x75, 0x65, 0x52, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65,
	0x61, 0x63, 0x74, 0x5f, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x72, 0x65, 0x61, 0x63, 0x74, 0x49, 0x63, 0x6f, 0x6e, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x6e, 0x67,
	0x75, 0x6c, 0x61, 0x72, 0x5f, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0b, 0x61, 0x6e, 0x67, 0x75, 0x6c, 0x61, 0x72, 0x49, 0x63, 0x6f, 0x6e, 0x22, 0x95, 0x01, 0x0a,
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x35, 0x0a, 0x0c, 0x6d, 0x65, 0x6e, 0x75, 0x4c, 0x69, 0x73,
	0x74, 0x54, 0x72, 0x65, 0x65, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x73, 0x79,
	0x73, 0x2e, 0x4d, 0x65, 0x6e, 0x75, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x72, 0x65, 0x65, 0x52, 0x0c,
	...
	0x18, 0x0a, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x03,
	0x52, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x73, 0x22, 0x2c, 0x0a, 0x16, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x6f, 0x6c, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52,
	0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x22, 0x64, 0x0a, 0x14, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xb8, 0x02,
	...
	0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x6a, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72,
	...
	,
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x94, 0x02, 0x0a, 0x08, 0x50,
	...
	,
	...
	,
...
var file_rpc_sys_sys_proto_goTypes = []interface{}{
	(*AddDeptReq)(nil),                // 0: sys.AddDeptReq
	(*AddDeptResp)(nil),               // 1: sys.AddDeptResp
	(*DeleteDeptReq)(nil),             // 2: sys.DeleteDeptReq
	(*DeleteDeptResp)(nil),            // 3: sys.DeleteDeptResp
	(*UpdateDeptReq)(nil),             // 4: sys.UpdateDeptReq
	(*UpdateDeptResp)(nil),            // 5: sys.UpdateDeptResp
	(*UpdateDeptStatusReq)(nil),       // 6: sys.UpdateDeptStatusReq
	(*UpdateDeptStatusResp)(nil),      // 7: sys.UpdateDeptStatusResp
	(*QueryDeptDetailReq)(nil),        // 8: sys.QueryDeptDetailReq
	(*QueryDeptDetailResp)(nil),       // 9: sys.QueryDeptDetailResp
	(*QueryDeptListReq)(nil),          // 10: sys.QueryDeptListReq
	(*DeptListData)(nil),              // 11: sys.DeptListData
	(*QueryDeptListResp)(nil),         // 12: sys.QueryDeptListResp
	(*AddDictItemReq)(nil),            // 13: sys.AddDictItemReq
	(*AddDictItemResp)(nil),           // 14: sys.AddDictItemResp
	(*DeleteDictItemReq)(nil),         // 15: sys.DeleteDictItemReq
	(*DeleteDictItemResp)(nil),        // 16: sys.DeleteDictItemResp
	(*UpdateDictItemReq)(nil),         // 17: sys.UpdateDictItemReq
	(*UpdateDictItemResp)(nil),        // 18: sys.UpdateDictItemResp
	(*UpdateDictItemStatusReq)(nil),   // 19: sys.UpdateDictItemStatusReq
	(*UpdateDictItemStatusResp)(nil),  // 20: sys.UpdateDictItemStatusResp
	(*QueryDictItemDetailReq)(nil),    // 21: sys.QueryDictItemDetailReq
	(*QueryDictItemDetailResp)(nil),   // 22: sys.QueryDictItemDetailResp
	(*QueryDictItemListReq)(nil),      // 23: sys.QueryDictItemListReq
	(*DictItemListData)(nil),          // 24: sys.DictItemListData
	(*QueryDictItemListResp)(nil),     // 25: sys.QueryDictItemListResp
	(*AddDictTypeReq)(nil),            // 26: sys.AddDictTypeReq
	(*AddDictTypeResp)(nil),           // 27: sys.AddDictTypeResp
	(*DeleteDictTypeReq)(nil),         // 28: sys.DeleteDictTypeReq
	(*DeleteDictTypeResp)(nil),        // 29: sys.DeleteDictTypeResp
	(*UpdateDictTypeReq)(nil),         // 30: sys.UpdateDictTypeReq
	(*UpdateDictTypeResp)(nil),        // 31: sys.UpdateDictTypeResp
	(*UpdateDictTypeStatusReq)(nil),   // 32: sys.UpdateDictTypeStatusReq
	(*UpdateDictTypeStatusResp)(nil),  // 33: sys.UpdateDictTypeStatusResp
	(*QueryDictTypeDetailReq)(nil),    // 34: sys.QueryDictTypeDetailReq
	(*QueryDictTypeDetailResp)(nil),   // 35: sys.QueryDictTypeDetailResp
	(*QueryDictTypeListReq)(nil),      // 36: sys.QueryDictTypeListReq
	(*DictTypeListData)(nil),          // 37: sys.DictTypeListData
	(*QueryDictTypeListResp)(nil),     // 38: sys.QueryDictTypeListResp
	(*DeleteLoginLogReq)(nil),         // 39: sys.DeleteLoginLogReq
	(*DeleteLoginLogResp)(nil),        // 40: sys.DeleteLoginLogResp
	(*QueryLoginLogDetailReq)(nil),    // 41: sys.QueryLoginLogDetailReq
	(*QueryLoginLogDetailResp)(nil),   // 42: sys.QueryLoginLogDetailResp
	(*QueryLoginLogListReq)(nil),      // 43: sys.QueryLoginLogListReq
	(*LoginLogListData)(nil),          // 44: sys.LoginLogListData
	(*QueryLoginLogListResp)(nil),     // 45: sys.QueryLoginLogListResp
	(*AddMenuReq)(nil),                // 46: sys.AddMenuReq
	(*AddMenuResp)(nil),               // 47: sys.AddMenuResp
	(*DeleteMenuReq)(nil),             // 48: sys.DeleteMenuReq
	(*DeleteMenuResp)(nil),            // 49: sys.DeleteMenuResp
	(*UpdateMenuReq)(nil),             // 50: sys.UpdateMenuReq
	(*UpdateMenuResp)(nil),            // 51: sys.UpdateMenuResp
	(*UpdateMenuStatusReq)(nil),       // 52: sys.UpdateMenuStatusReq
	(*UpdateMenuStatusResp)(nil),      // 53: sys.UpdateMenuStatusResp
	(*QueryMenuDetailReq)(nil),        // 54: sys.QueryMenuDetailReq
	(*QueryMenuDetailResp)(nil),       // 55: sys.QueryMenuDetailResp
	(*QueryMenuListReq)(nil),          // 56: sys.QueryMenuListReq
	(*MenuListData)(nil),              // 57: sys.MenuListData
	(*QueryMenuListResp)(nil),         // 58: sys.QueryMenuListResp
	(*AddNoticeReq)(nil),              // 59: sys.AddNoticeReq
	(*AddNoticeResp)(nil),             // 60: sys.AddNoticeResp
	(*DeleteNoticeReq)(nil),           // 61: sys.DeleteNoticeReq
	(*DeleteNoticeResp)(nil),          // 62: sys.DeleteNoticeResp
	(*UpdateNoticeReq)(nil),           // 63: sys.UpdateNoticeReq
	(*UpdateNoticeResp)(nil),          // 64: sys.UpdateNoticeResp
	(*UpdateNoticeStatusReq)(nil),     // 65: sys.UpdateNoticeStatusReq
	(*UpdateNoticeStatusResp)(nil),    // 66: sys.UpdateNoticeStatusResp
	(*QueryNoticeDetailReq)(nil),      // 67: sys.QueryNoticeDetailReq
	(*QueryNoticeDetailResp)(nil),     // 68: sys.QueryNoticeDetailResp
	(*QueryNoticeListReq)(nil),        // 69: sys.QueryNoticeListReq
	(*QueryNoticeListResp)(nil),       // 70: sys.QueryNoticeListResp
	(*QueryNoticeListData)(nil),       // 71: sys.QueryNoticeListData
	(*AddOperateLogReq)(nil),          // 72: sys.AddOperateLogReq
	(*AddOperateLogResp)(nil),         // 73: sys.AddOperateLogResp
	(*DeleteOperateLogReq)(nil),       // 74: sys.DeleteOperateLogReq
	(*DeleteOperateLogResp)(nil),      // 75: sys.DeleteOperateLogResp
	(*QueryOperateLogDetailReq)(nil),  // 76: sys.QueryOperateLogDetailReq
	(*QueryOperateLogDetailResp)(nil), // 77: sys.QueryOperateLogDetailResp
	(*QueryOperateLogListReq)(nil),    // 78: sys.QueryOperateLogListReq
	(*OperateLogListData)(nil),        // 79: sys.OperateLogListData
	(*QueryOperateLogListResp)(nil),   // 80: sys.QueryOperateLogListResp
	(*AddPostReq)(nil),                // 81: sys.AddPostReq
	(*AddPostResp)(nil),               // 82: sys.AddPostResp
	(*DeletePostReq)(nil),             // 83: sys.DeletePostReq
	(*DeletePostResp)(nil),            // 84: sys.DeletePostResp
	(*UpdatePostReq)(nil),             // 85: sys.UpdatePostReq
	(*UpdatePostResp)(nil),            // 86: sys.UpdatePostResp
	(*UpdatePostStatusReq)(nil),       // 87: sys.UpdatePostStatusReq
	(*UpdatePostStatusResp)(nil),      // 88: sys.UpdatePostStatusResp
	(*QueryPostDetailReq)(nil),        // 89: sys.QueryPostDetailReq
	(*QueryPostDetailResp)(nil),       // 90: sys.QueryPostDetailResp
	(*QueryPostListReq)(nil),          // 91: sys.QueryPostListReq
	(*PostListData)(nil),              // 92: sys.PostListData
	(*QueryPostListResp)(nil),         // 93: sys.QueryPostListResp
	(*AddRoleReq)(nil),                // 94: sys.AddRoleReq
	(*AddRoleResp)(nil),               // 95: sys.AddRoleResp
	(*DeleteRoleReq)(nil),             // 96: sys.DeleteRoleReq
	(*DeleteRoleResp)(nil),            // 97: sys.DeleteRoleResp
	(*UpdateRoleReq)(nil),             // 98: sys.UpdateRoleReq
	(*UpdateRoleResp)(nil),            // 99: sys.UpdateRoleResp
	(*UpdateRoleStatusReq)(nil),       // 100: sys.UpdateRoleStatusReq
	(*UpdateRoleStatusResp)(nil),      // 101: sys.UpdateRoleStatusResp
	(*QueryRoleDetailReq)(nil),        // 102: sys.QueryRoleDetailReq
	(*QueryRoleDetailResp)(nil),       // 103: sys.QueryRoleDetailResp
	(*QueryRoleListReq)(nil),          // 104: sys.QueryRoleListReq
	(*RoleListData)(nil),              // 105: sys.RoleListData
	(*QueryRoleListResp)(nil),         // 106: sys.QueryRoleListResp
	(*QueryRoleMenuListReq)(nil),      // 107: sys.QueryRoleMenuListReq
	(*MenuData)(nil),                  // 108: sys.MenuData
	(*QueryRoleMenuListResp)(nil),     // 109: sys.QueryRoleMenuListResp
	(*UpdateRoleMenuReq)(nil),         // 110: sys.UpdateRoleMenuReq
	(*UpdateRoleMenuResp)(nil),        // 111: sys.UpdateRoleMenuResp
	(*QueryRoleUserListReq)(nil),      // 112: sys.QueryRoleUserListReq
	(*UserData)(nil),                  // 113: sys.UserData
	(*QueryRoleUserListResp)(nil),     // 114: sys.QueryRoleUserListResp
	(*CancelAuthorizationReq)(nil),    // 115: sys.CancelAuthorizationReq
	(*CancelAuthorizationResp)(nil),   // 116: sys.CancelAuthorizationResp
	(*AddUserReq)(nil),                // 117: sys.AddUserReq
	(*AddUserResp)(nil),               // 118: sys.AddUserResp
	(*DeleteUserReq)(nil),             // 119: sys.DeleteUserReq
	(*DeleteUserResp)(nil),            // 120: sys.DeleteUserResp
	(*UpdateUserReq)(nil),             // 121: sys.UpdateUserReq
	(*UpdateUserResp)(nil),            // 122: sys.UpdateUserResp
	(*UpdateUserStatusReq)(nil),       // 123: sys.UpdateUserStatusReq
	(*UpdateUserStatusResp)(nil),      // 124: sys.UpdateUserStatusResp
	(*QueryUserDetailReq)(nil),        // 125: sys.QueryUserDetailReq
	(*QueryUserDetailResp)(nil),       // 126: sys.QueryUserDetailResp
	(*QueryUserListReq)(nil),          // 127: sys.QueryUserListReq
	(*UserListData)(nil),              // 128: sys.UserListData
	(*QueryUserListResp)(nil),         // 129: sys.QueryUserListResp
	(*LoginReq)(nil),                  // 130: sys.LoginReq
	(*LoginResp)(nil),                 // 131: sys.loginResp
	(*InfoReq)(nil),                   // 132: sys.InfoReq
	(*MenuListTree)(nil),              // 133: sys.MenuListTree
	(*InfoResp)(nil),                  // 134: sys.InfoResp
	(*ReSetPasswordReq)(nil),          // 135: sys.ReSetPasswordReq
	(*ReSetPasswordResp)(nil),         // 136: sys.ReSetPasswordResp
	(*UpdateUserRoleListReq)(nil),     // 137: sys.UpdateUserRoleListReq
	(*UpdateUserRoleListResp)(nil),    // 138: sys.UpdateUserRoleListResp
	(*QueryUserRoleListReq)(nil),      // 139: sys.QueryUserRoleListReq
	(*RoleData)(nil),                  // 140: sys.RoleData
	(*QueryUserRoleListResp)(nil),     // 141: sys.QueryUserRoleListResp
	(*QueryDeptAndPostListReq)(nil),   // 142: sys.QueryDeptAndPostListReq
	(*QueryDeptAndPostListResp)(nil),  // 143: sys.QueryDeptAndPostListResp
	(*DeptData)(nil),                  // 144: sys.DeptData
	(*PostData)(nil),                  // 145: sys.PostData
}
var file_rpc_sys_sys_proto_depIdxs = []int32{
	11,  // 0: sys.QueryDeptListResp.list:type_name -> sys.DeptListData
	24,  // 1: sys.QueryDictItemListResp.list:type_name -> sys.DictItemListData
	37,  // 2: sys.QueryDictTypeListResp.list:type_name -> sys.DictTypeListData
	44,  // 3: sys.QueryLoginLogListResp.list:type_name -> sys.LoginLogListData
	57,  // 4: sys.QueryMenuListResp.list:type_name -> sys.MenuListData
	71,  // 5: sys.QueryNoticeListResp.list:type_name -> sys.QueryNoticeListData
	79,  // 6: sys.QueryOperateLogListResp.list:type_name -> sys.OperateLogListData
	92,  // 7: sys.QueryPostListResp.list:type_name -> sys.PostListData
	105, // 8: sys.QueryRoleListResp.list:type_name -> sys.RoleListData
	108, // 9: sys.QueryRoleMenuListResp.list:type_name -> sys.MenuData
	113, // 10: sys.QueryRoleUserListResp.list:type_name -> sys.UserData
	128, // 11: sys.QueryUserListResp.list:type_name -> sys.UserListData
	133, // 12: sys.InfoResp.menuListTree:type_name -> sys.MenuListTree
	140, // 13: sys.QueryUserRoleListResp.list:type_name -> sys.RoleData
	144, // 14: sys.QueryDeptAndPostListResp.dept_list_data:type_name -> sys.DeptData
	145, // 15: sys.QueryDeptAndPostListResp.post_list_data:type_name -> sys.PostData
	0,   // 16: sys.DeptService.AddDept:input_type -> sys.AddDeptReq
	2,   // 17: sys.DeptService.DeleteDept:input_type -> sys.DeleteDeptReq
	4,   // 18: sys.DeptService.UpdateDept:input_type -> sys.UpdateDeptReq
	6,   // 19: sys.DeptService.UpdateDeptStatus:input_type -> sys.UpdateDeptStatusReq
	8,   // 20: sys.DeptService.QueryDeptDetail:input_type -> sys.QueryDeptDetailReq
	10,  // 21: sys.DeptService.QueryDeptList:input_type -> sys.QueryDeptListReq
	13,  // 22: sys.DictItemService.AddDictItem:input_type -> sys.AddDictItemReq
	15,  // 23: sys.DictItemService.DeleteDictItem:input_type -> sys.DeleteDictItemReq
	17,  // 24: sys.DictItemService.UpdateDictItem:input_type -> sys.UpdateDictItemReq
	19,  // 25: sys.DictItemService.UpdateDictItemStatus:input_type -> sys.UpdateDictItemStatusReq
	21,  // 26: sys.DictItemService.QueryDictItemDetail:input_type -> sys.QueryDictItemDetailReq
	23,  // 27: sys.DictItemService.QueryDictItemList:input_type -> sys.QueryDictItemListReq
	26,  // 28: sys.DictTypeService.AddDictType:input_type -> sys.AddDictTypeReq
	28,  // 29: sys.DictTypeService.DeleteDictType:input_type -> sys.DeleteDictTypeReq
	30,  // 30: sys.DictTypeService.UpdateDictType:input_type -> sys.UpdateDictTypeReq
	32,  // 31: sys.DictTypeService.UpdateDictTypeStatus:input_type -> sys.UpdateDictTypeStatusReq
	34,  // 32: sys.DictTypeService.QueryDictTypeDetail:input_type -> sys.QueryDictTypeDetailReq
	36,  // 33: sys.DictTypeService.QueryDictTypeList:input_type -> sys.QueryDictTypeListReq
	39,  // 34: sys.LoginLogService.DeleteLoginLog:input_type -> sys.DeleteLoginLogReq
	41,  // 35: sys.LoginLogService.QueryLoginLogDetail:input_type -> sys.QueryLoginLogDetailReq
	43,  // 36: sys.LoginLogService.QueryLoginLogList:input_type -> sys.QueryLoginLogListReq
	46,  // 37: sys.MenuService.AddMenu:input_type -> sys.AddMenuReq
	48,  // 38: sys.MenuService.DeleteMenu:input_type -> sys.DeleteMenuReq
	50,  // 39: sys.MenuService.UpdateMenu:input_type -> sys.UpdateMenuReq
	52,  // 40: sys.MenuService.UpdateMenuStatus:input_type -> sys.UpdateMenuStatusReq
	54,  // 41: sys.MenuService.QueryMenuDetail:input_type -> sys.QueryMenuDetailReq
	56,  // 42: sys.MenuService.QueryMenuList:input_type -> sys.QueryMenuListReq
	56,  // 43: sys.MenuService.QueryMenuResourceList:input_type -> sys.QueryMenuListReq
	59,  // 44: sys.NoticeService.AddNotice:input_type -> sys.AddNoticeReq
	61,  // 45: sys.NoticeService.DeleteNotice:input_type -> sys.DeleteNoticeReq
	63,  // 46: sys.NoticeService.UpdateNotice:input_type -> sys.UpdateNoticeReq
	65,  // 47: sys.NoticeService.UpdateNoticeStatus:input_type -> sys.UpdateNoticeStatusReq
	67,  // 48: sys.NoticeService.QueryNoticeDetail:input_type -> sys.QueryNoticeDetailReq
	69,  // 49: sys.NoticeService.QueryNoticeList:input_type -> sys.QueryNoticeListReq
	72,  // 50: sys.OperateLogService.AddOperateLog:input_type -> sys.AddOperateLogReq
	74,  // 51: sys.OperateLogService.DeleteOperateLog:input_type -> sys.DeleteOperateLogReq
	76,  // 52: sys.OperateLogService.QueryOperateLogDetail:input_type -> sys.QueryOperateLogDetailReq
	78,  // 53: sys.OperateLogService.QueryOperateLogList:input_type -> sys.QueryOperateLogListReq
	81,  // 54: sys.PostService.AddPost:input_type -> sys.AddPostReq
	83,  // 55: sys.PostService.DeletePost:input_type -> sys.DeletePostReq
	85,  // 56: sys.PostService.UpdatePost:input_type -> sys.UpdatePostReq
	87,  // 57: sys.PostService.UpdatePostStatus:input_type -> sys.UpdatePostStatusReq
	89,  // 58: sys.PostService.QueryPostDetail:input_type -> sys.QueryPostDetailReq
	91,  // 59: sys.PostService.QueryPostList:input_type -> sys.QueryPostListReq
	94,  // 60: sys.RoleService.AddRole:input_type -> sys.AddRoleReq
	96,  // 61: sys.RoleService.DeleteRole:input_type -> sys.DeleteRoleReq
	98,  // 62: sys.RoleService.UpdateRole:input_type -> sys.UpdateRoleReq
	100, // 63: sys.RoleService.UpdateRoleStatus:input_type -> sys.UpdateRoleStatusReq
	102, // 64: sys.RoleService.QueryRoleDetail:input_type -> sys.QueryRoleDetailReq
	104, // 65: sys.RoleService.QueryRoleList:input_type -> sys.QueryRoleListReq
	107, // 66: sys.RoleService.QueryRoleMenuList:input_type -> sys.QueryRoleMenuListReq
	110, // 67: sys.RoleService.UpdateMenuRoleList:input_type -> sys.UpdateRoleMenuReq
	112, // 68: sys.RoleService.QueryRoleUserList:input_type -> sys.QueryRoleUserListReq
	115, // 69: sys.RoleService.CancelAuthorization:input_type -> sys.CancelAuthorizationReq
	117, // 70: sys.UserService.AddUser:input_type -> sys.AddUserReq
	119, // 71: sys.UserService.DeleteUser:input_type -> sys.DeleteUserReq
	121, // 72: sys.UserService.UpdateUser:input_type -> sys.UpdateUserReq
	123, // 73: sys.UserService.UpdateUserStatus:input_type -> sys.UpdateUserStatusReq
	125, // 74: sys.UserService.QueryUserDetail:input_type -> sys.QueryUserDetailReq
	127, // 75: sys.UserService.QueryUserList:input_type -> sys.QueryUserListReq
	130, // 76: sys.UserService.Login:input_type -> sys.LoginReq
	132, // 77: sys.UserService.UserInfo:input_type -> sys.InfoReq
	135, // 78: sys.UserService.ReSetPassword:input_type -> sys.ReSetPasswordReq
	139, // 79: sys.UserService.QueryUserRoleList:input_type -> sys.QueryUserRoleListReq
	137, // 80: sys.UserService.UpdateUserRoleList:input_type -> sys.UpdateUserRoleListReq
	142, // 81: sys.UserService.QueryDeptAndPostList:input_type -> sys.QueryDeptAndPostListReq
	1,   // 82: sys.DeptService.AddDept:output_type -> sys.AddDeptResp
	3,   // 83: sys.DeptService.DeleteDept:output_type -> sys.DeleteDeptResp
	5,   // 84: sys.DeptService.UpdateDept:output_type -> sys.UpdateDeptResp
	7,   // 85: sys.DeptService.UpdateDeptStatus:output_type -> sys.UpdateDeptStatusResp
	9,   // 86: sys.DeptService.QueryDeptDetail:output_type -> sys.QueryDeptDetailResp
	12,  // 87: sys.DeptService.QueryDeptList:output_type -> sys.QueryDeptListResp
	14,  // 88: sys.DictItemService.AddDictItem:output_type -> sys.AddDictItemResp
	16,  // 89: sys.DictItemService.DeleteDictItem:output_type -> sys.DeleteDictItemResp
	18,  // 90: sys.DictItemService.UpdateDictItem:output_type -> sys.UpdateDictItemResp
	20,  // 91: sys.DictItemService.UpdateDictItemStatus:output_type -> sys.UpdateDictItemStatusResp
	22,  // 92: sys.DictItemService.QueryDictItemDetail:output_type -> sys.QueryDictItemDetailResp
	25,  // 93: sys.DictItemService.QueryDictItemList:output_type -> sys.QueryDictItemListResp
	27,  // 94: sys.DictTypeService.AddDictType:output_type -> sys.AddDictTypeResp
	29,  // 95: sys.DictTypeService.DeleteDictType:output_type -> sys.DeleteDictTypeResp
	31,  // 96: sys.DictTypeService.UpdateDictType:output_type -> sys.UpdateDictTypeResp
	33,  // 97: sys.DictTypeService.UpdateDictTypeStatus:output_type -> sys.UpdateDictTypeStatusResp
	35,  // 98: sys.DictTypeService.QueryDictTypeDetail:output_type -> sys.QueryDictTypeDetailResp
	38,  // 99: sys.DictTypeService.QueryDictTypeList:output_type -> sys.QueryDictTypeListResp
	40,  // 100: sys.LoginLogService.DeleteLoginLog:output_type -> sys.DeleteLoginLogResp
	42,  // 101: sys.LoginLogService.QueryLoginLogDetail:output_type -> sys.QueryLoginLogDetailResp
	45,  // 102: sys.LoginLogService.QueryLoginLogList:output_type -> sys.QueryLoginLogListResp
	47,  // 103: sys.MenuService.AddMenu:output_type -> sys.AddMenuResp
	49,  // 104: sys.MenuService.DeleteMenu:output_type -> sys.DeleteMenuResp
	51,  // 105: sys.MenuService.UpdateMenu:output_type -> sys.UpdateMenuResp
	53,  // 106: sys.MenuService.UpdateMenuStatus:output_type -> sys.UpdateMenuStatusResp
	55,  // 107: sys.MenuService.QueryMenuDetail:output_type -> sys.QueryMenuDetailResp
	58,  // 108: sys.MenuService.QueryMenuList:output_type -> sys.QueryMenuListResp
	58,  // 109: sys.MenuService.QueryMenuResourceList:output_type -> sys.QueryMenuListResp
	60,  // 110: sys.NoticeService.AddNotice:output_type -> sys.AddNoticeResp
	62,  // 111: sys.NoticeService.DeleteNotice:output_type -> sys.DeleteNoticeResp
	64,  // 112: sys.NoticeService.UpdateNotice:output_type -> sys.UpdateNoticeResp
	66,  // 113: sys.NoticeService.UpdateNoticeStatus:output_type -> sys.UpdateNoticeStatusResp
	68,  // 114: sys.NoticeService.QueryNoticeDetail:output_type -> sys.QueryNoticeDetailResp
	70,  // 115: sys.NoticeService.QueryNoticeList:output_type -> sys.QueryNoticeListResp
	73,  // 116: sys.OperateLogService.AddOperateLog:output_type -> sys.AddOperateLogResp
	75,  // 117: sys.OperateLogService.DeleteOperateLog:output_type -> sys.DeleteOperateLogResp
	77,  // 118: sys.OperateLogService.QueryOperateLogDetail:output_type -> sys.QueryOperateLogDetailResp
	80,  // 119: sys.OperateLogService.QueryOperateLogList:output_type -> sys.QueryOperateLogListResp
	82,  // 120: sys.PostService.AddPost:output_type -> sys.AddPostResp
	84,  // 121: sys.PostService.DeletePost:output_type -> sys.DeletePostResp
	86,  // 122: sys.PostService.UpdatePost:output_type -> sys.UpdatePostResp
	88,  // 123: sys.PostService.UpdatePostStatus:output_type -> sys.UpdatePostStatusResp
	90,  // 124: sys.PostService.QueryPostDetail:output_type -> sys.QueryPostDetailResp
	93,  // 125: sys.PostService.QueryPostList:output_type -> sys.QueryPostListResp
	95,  // 126: sys.RoleService.AddRole:output_type -> sys.AddRoleResp
	97,  // 127: sys.RoleService.DeleteRole:output_type -> sys.DeleteRoleResp
	99,  // 128: sys.RoleService.UpdateRole:output_type -> sys.UpdateRoleResp
	101, // 129: sys.RoleService.UpdateRoleStatus:output_type -> sys.UpdateRoleStatusResp
	103, // 130: sys.RoleService.QueryRoleDetail:output_type -> sys.QueryRoleDetailResp
	106, // 131: sys.RoleService.QueryRoleList:output_type -> sys.QueryRoleListResp
	109, // 132: sys.RoleService.QueryRoleMenuList:output_type -> sys.QueryRoleMenuListResp
	111, // 133: sys.RoleService.UpdateMenuRoleList:output_type -> sys.UpdateRoleMenuResp
	114, // 134: sys.RoleService.QueryRoleUserList:output_type -> sys.QueryRoleUserListResp
	116, // 135: sys.RoleService.CancelAuthorization:output_type -> sys.CancelAuthorizationResp
	118, // 136: sys.UserService.AddUser:output_type -> sys.AddUserResp
	120, // 137: sys.UserService.DeleteUser:output_type -> sys.DeleteUserResp
	122, // 138: sys.UserService.UpdateUser:output_type -> sys.UpdateUserResp
	124, // 139: sys.UserService.UpdateUserStatus:output_type -> sys.UpdateUserStatusResp
	126, // 140: sys.UserService.QueryUserDetail:output_type -> sys.QueryUserDetailResp
	129, // 141: sys.UserService.QueryUserList:output_type -> sys.QueryUserListResp
	131, // 142: sys.UserService.Login:output_type -> sys.loginResp
	134, // 143: sys.UserService.UserInfo:output_type -> sys.InfoResp
	136, // 144: sys.UserService.ReSetPassword:output_type -> sys.ReSetPasswordResp
	141, // 145: sys.UserService.QueryUserRoleList:output_type -> sys.QueryUserRoleListResp
	138, // 146: sys.UserService.UpdateUserRoleList:output_type -> sys.UpdateUserRoleListResp
	143, // 147: sys.UserService.QueryDeptAndPostList:output_type -> sys.QueryDeptAndPostListResp
