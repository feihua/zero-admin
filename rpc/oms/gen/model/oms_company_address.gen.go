...
type OmsCompanyAddress struct {
	...
	SendStatus    int32      `gorm:"column:send_status;not null;default:1;comment:默认发货地址：0->否；1->是" json:"send_status"`       // 默认发货地址：0->否；1->是
	ReceiveStatus int32      `gorm:"column:receive_status;not null;default:1;comment:默认收货地址：0->否；1->是" json:"receive_status"` // 默认收货地址：0->否；1->是
