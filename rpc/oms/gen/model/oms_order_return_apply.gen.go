...
type OmsOrderReturnApply struct {
	...
	HandleTime       time.Time `gorm:"column:handle_time;not null;comment:处理时间" json:"handle_time"`                   // 处理时间
	...
	ReceiveTime      time.Time `gorm:"column:receive_time;not null;comment:收货时间" json:"receive_time"`                 // 收货时间
