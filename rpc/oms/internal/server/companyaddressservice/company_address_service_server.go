...
// 更新公司默认发货地址
func (s *CompanyAddressServiceServer) UpdateCompanyAddressSendStatus(ctx context.Context, in *omsclient.UpdateCompanyAddressStatusReq) (*omsclient.UpdateCompanyAddressStatusResp, error) {
...
// 更新公司默认收货地址
func (s *CompanyAddressServiceServer) UpdateCompanyAddressReceiveStatus(ctx context.Context, in *omsclient.UpdateCompanyAddressStatusReq) (*omsclient.UpdateCompanyAddressStatusResp, error) {
