...
// 更新订单设置表是否为默认
func (m *defaultOrderSettingService) UpdateOrderSettingIsDefault(ctx context.Context, in *UpdateOrderSettingIsDefaultReq, opts ...grpc.CallOption) (*UpdateOrderSettingStatusResp, error) {
	client := omsclient.NewOrderSettingServiceClient(m.cli.Conn())
	return client.UpdateOrderSettingIsDefault(ctx, in, opts...)
}
