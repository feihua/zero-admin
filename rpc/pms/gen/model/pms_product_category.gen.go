...
type PmsProductCategory struct {
	...
	Level        int32      `gorm:"column:level;not null;default:1;comment:分类级别：0->1级；1->2级" json:"level"`                   // 分类级别：0->1级；1->2级
	ProductCount int32      `gorm:"column:product_count;not null;comment:商品数量" json:"product_count"`                         // 商品数量
	ProductUnit  string     `gorm:"column:product_unit;not null;comment:商品单位" json:"product_unit"`                           // 商品单位
	NavStatus    int32      `gorm:"column:nav_status;not null;default:1;comment:是否显示在导航栏：0->不显示；1->显示" json:"nav_status"`    // 是否显示在导航栏：0->不显示；1->显示
	...
	Keywords     string     `gorm:"column:keywords;not null;default:''::character varying;comment:关键字" json:"keywords"`      // 关键字
	Description  string     `gorm:"column:description;not null;default:''::character varying;comment:描述" json:"description"` // 描述
