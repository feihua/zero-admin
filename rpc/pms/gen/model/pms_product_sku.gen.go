...
// PmsProductSku mapped from table <pms_product_sku>
type PmsProductSku struct {
	...
	VerifyStatus       int32      `gorm:"column:verify_status;not null;default:1;comment:审核状态：0-未审核，1-审核通过，2-审核不通过" json:"verify_status"` // 审核状态：0-未审核，1-审核通过，2-审核不通过
