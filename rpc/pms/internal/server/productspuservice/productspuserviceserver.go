...
// 添加商品SPU
func (s *ProductSpuServiceServer) AddProductSpu(ctx context.Context, in *pmsclient.AddProductSpuReq) (*pmsclient.AddProductSpuResp, error) {
...
// 更新商品SPU
func (s *ProductSpuServiceServer) UpdateProductSpu(ctx context.Context, in *pmsclient.UpdateProductSpuReq) (*pmsclient.UpdateProductSpuResp, error) {
