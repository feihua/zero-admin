...
type ProductListByIdsLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewProductListByIdsLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ProductListByIdsLogic {
	return &ProductListByIdsLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *ProductListByIdsLogic) ProductListByIds(in *pmsclient.ProductListByIdsReq) (*pmsclient.ProductListByIdsResp, error) {
	...
	return &pmsclient.ProductListByIdsResp{
		List: list,
	}, nil
	// return &pmsclient.ProductListByIdsResp{}, nil
}
