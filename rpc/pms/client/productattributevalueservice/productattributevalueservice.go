...
func (m *defaultProductAttributeValueService) ProductAttributeValueAdd(ctx context.Context, in *ProductAttributeValueAddReq, opts ...grpc.CallOption) (*ProductAttributeValueAddResp, error) {
	client := pmsclient.NewProductAttributeValueServiceClient(m.cli.Conn())
	return client.ProductAttributeValueAdd(ctx, in, opts...)
}

func (m *defaultProductAttributeValueService) ProductAttributeValueList(ctx context.Context, in *ProductAttributeValueListReq, opts ...grpc.CallOption) (*ProductAttributeValueListResp, error) {
	client := pmsclient.NewProductAttributeValueServiceClient(m.cli.Conn())
	return client.ProductAttributeValueList(ctx, in, opts...)
}

func (m *defaultProductAttributeValueService) ProductAttributeValueUpdate(ctx context.Context, in *ProductAttributeValueUpdateReq, opts ...grpc.CallOption) (*ProductAttributeValueUpdateResp, error) {
	client := pmsclient.NewProductAttributeValueServiceClient(m.cli.Conn())
	return client.ProductAttributeValueUpdate(ctx, in, opts...)
}

func (m *defaultProductAttributeValueService) ProductAttributeValueDelete(ctx context.Context, in *ProductAttributeValueDeleteReq, opts ...grpc.CallOption) (*ProductAttributeValueDeleteResp, error) {
	client := pmsclient.NewProductAttributeValueServiceClient(m.cli.Conn())
