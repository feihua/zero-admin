...
func (m *defaultProductOperateLogService) ProductOperateLogAdd(ctx context.Context, in *ProductOperateLogAddReq, opts ...grpc.CallOption) (*ProductOperateLogAddResp, error) {
	client := pmsclient.NewProductOperateLogServiceClient(m.cli.Conn())
	return client.ProductOperateLogAdd(ctx, in, opts...)
}

func (m *defaultProductOperateLogService) ProductOperateLogList(ctx context.Context, in *ProductOperateLogListReq, opts ...grpc.CallOption) (*ProductOperateLogListResp, error) {
	client := pmsclient.NewProductOperateLogServiceClient(m.cli.Conn())
	return client.ProductOperateLogList(ctx, in, opts...)
}

func (m *defaultProductOperateLogService) ProductOperateLogUpdate(ctx context.Context, in *ProductOperateLogUpdateReq, opts ...grpc.CallOption) (*ProductOperateLogUpdateResp, error) {
	client := pmsclient.NewProductOperateLogServiceClient(m.cli.Conn())
	return client.ProductOperateLogUpdate(ctx, in, opts...)
}

func (m *defaultProductOperateLogService) ProductOperateLogDelete(ctx context.Context, in *ProductOperateLogDeleteReq, opts ...grpc.CallOption) (*ProductOperateLogDeleteResp, error) {
	client := pmsclient.NewProductOperateLogServiceClient(m.cli.Conn())
