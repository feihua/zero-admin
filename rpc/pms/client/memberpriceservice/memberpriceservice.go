...
type (
	...
	defaultMemberPriceService struct {
		cli zrpc.Client
	}
)

func NewMemberPriceService(cli zrpc.Client) MemberPriceService {
	return &defaultMemberPriceService{
		cli: cli,
	}
}

func (m *defaultMemberPriceService) MemberPriceAdd(ctx context.Context, in *MemberPriceAddReq, opts ...grpc.CallOption) (*MemberPriceAddResp, error) {
	client := pmsclient.NewMemberPriceServiceClient(m.cli.Conn())
	return client.MemberPriceAdd(ctx, in, opts...)
}

func (m *defaultMemberPriceService) MemberPriceList(ctx context.Context, in *MemberPriceListReq, opts ...grpc.CallOption) (*MemberPriceListResp, error) {
	client := pmsclient.NewMemberPriceServiceClient(m.cli.Conn())
	return client.MemberPriceList(ctx, in, opts...)
}

func (m *defaultMemberPriceService) MemberPriceUpdate(ctx context.Context, in *MemberPriceUpdateReq, opts ...grpc.CallOption) (*MemberPriceUpdateResp, error) {
	client := pmsclient.NewMemberPriceServiceClient(m.cli.Conn())
	return client.MemberPriceUpdate(ctx, in, opts...)
}

func (m *defaultMemberPriceService) MemberPriceDelete(ctx context.Context, in *MemberPriceDeleteReq, opts ...grpc.CallOption) (*MemberPriceDeleteResp, error) {
	client := pmsclient.NewMemberPriceServiceClient(m.cli.Conn())
