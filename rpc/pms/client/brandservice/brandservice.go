...
func (m *defaultBrandService) BrandAdd(ctx context.Context, in *BrandAddReq, opts ...grpc.CallOption) (*BrandAddResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.BrandAdd(ctx, in, opts...)
}

func (m *defaultBrandService) BrandList(ctx context.Context, in *BrandListReq, opts ...grpc.CallOption) (*BrandListResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.BrandList(ctx, in, opts...)
}

func (m *defaultBrandService) BrandListByIds(ctx context.Context, in *BrandListByIdsReq, opts ...grpc.CallOption) (*BrandListResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
