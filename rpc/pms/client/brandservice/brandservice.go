...
func NewBrandService(cli zrpc.Client) BrandService {
	return &defaultBrandService{
		cli: cli,
	}
}

// 添加品牌表
func (m *defaultBrandService) AddBrand(ctx context.Context, in *AddBrandReq, opts ...grpc.CallOption) (*AddBrandResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.AddBrand(ctx, in, opts...)
}

// 删除品牌表
func (m *defaultBrandService) DeleteBrand(ctx context.Context, in *DeleteBrandReq, opts ...grpc.CallOption) (*DeleteBrandResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.DeleteBrand(ctx, in, opts...)
}

// 更新品牌表
func (m *defaultBrandService) UpdateBrand(ctx context.Context, in *UpdateBrandReq, opts ...grpc.CallOption) (*UpdateBrandResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.UpdateBrand(ctx, in, opts...)
}

// 查询品牌表详情
func (m *defaultBrandService) QueryBrandDetail(ctx context.Context, in *QueryBrandDetailReq, opts ...grpc.CallOption) (*QueryBrandDetailResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.QueryBrandDetail(ctx, in, opts...)
}

// 查询品牌表列表
func (m *defaultBrandService) QueryBrandList(ctx context.Context, in *QueryBrandListReq, opts ...grpc.CallOption) (*QueryBrandListResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.QueryBrandList(ctx, in, opts...)
}

func (m *defaultBrandService) QueryBrandListByIds(ctx context.Context, in *QueryBrandListByIdsReq, opts ...grpc.CallOption) (*QueryBrandListResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.QueryBrandListByIds(ctx, in, opts...)
}

// 更新品牌的显示状态
func (m *defaultBrandService) UpdateBrandShowStatus(ctx context.Context, in *UpdateBrandShowStatusReq, opts ...grpc.CallOption) (*UpdateBrandStatusResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.UpdateBrandShowStatus(ctx, in, opts...)
}

// 更新品牌是否为品牌制造商
func (m *defaultBrandService) UpdateBrandFactoryStatus(ctx context.Context, in *UpdateBrandFactoryStatusReq, opts ...grpc.CallOption) (*UpdateBrandStatusResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
	return client.UpdateBrandFactoryStatus(ctx, in, opts...)
}

// 更新品牌的推荐状态
func (m *defaultBrandService) UpdateBrandRecommendStatus(ctx context.Context, in *UpdateBrandRecommendStatusReq, opts ...grpc.CallOption) (*UpdateBrandStatusResp, error) {
	client := pmsclient.NewBrandServiceClient(m.cli.Conn())
