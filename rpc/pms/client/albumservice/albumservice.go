...
type (
	...
	defaultAlbumService struct {
		cli zrpc.Client
	}
)

func NewAlbumService(cli zrpc.Client) AlbumService {
	return &defaultAlbumService{
		cli: cli,
	}
}

func (m *defaultAlbumService) AlbumAdd(ctx context.Context, in *AlbumAddReq, opts ...grpc.CallOption) (*AlbumAddResp, error) {
	client := pmsclient.NewAlbumServiceClient(m.cli.Conn())
	return client.AlbumAdd(ctx, in, opts...)
}

func (m *defaultAlbumService) AlbumList(ctx context.Context, in *AlbumListReq, opts ...grpc.CallOption) (*AlbumListResp, error) {
	client := pmsclient.NewAlbumServiceClient(m.cli.Conn())
	return client.AlbumList(ctx, in, opts...)
}

func (m *defaultAlbumService) AlbumUpdate(ctx context.Context, in *AlbumUpdateReq, opts ...grpc.CallOption) (*AlbumUpdateResp, error) {
	client := pmsclient.NewAlbumServiceClient(m.cli.Conn())
	return client.AlbumUpdate(ctx, in, opts...)
}

func (m *defaultAlbumService) AlbumDelete(ctx context.Context, in *AlbumDeleteReq, opts ...grpc.CallOption) (*AlbumDeleteResp, error) {
	client := pmsclient.NewAlbumServiceClient(m.cli.Conn())
