...
// 添加产品属性分类表
func (m *defaultProductAttributeCategoryService) AddProductAttributeCategory(ctx context.Context, in *AddProductAttributeCategoryReq, opts ...grpc.CallOption) (*AddProductAttributeCategoryResp, error) {
	client := pmsclient.NewProductAttributeCategoryServiceClient(m.cli.Conn())
	return client.AddProductAttributeCategory(ctx, in, opts...)
}

// 删除产品属性分类表
func (m *defaultProductAttributeCategoryService) DeleteProductAttributeCategory(ctx context.Context, in *DeleteProductAttributeCategoryReq, opts ...grpc.CallOption) (*DeleteProductAttributeCategoryResp, error) {
	client := pmsclient.NewProductAttributeCategoryServiceClient(m.cli.Conn())
	return client.DeleteProductAttributeCategory(ctx, in, opts...)
}

// 更新产品属性分类表
func (m *defaultProductAttributeCategoryService) UpdateProductAttributeCategory(ctx context.Context, in *UpdateProductAttributeCategoryReq, opts ...grpc.CallOption) (*UpdateProductAttributeCategoryResp, error) {
	client := pmsclient.NewProductAttributeCategoryServiceClient(m.cli.Conn())
	return client.UpdateProductAttributeCategory(ctx, in, opts...)
}

// 查询产品属性分类表列表
func (m *defaultProductAttributeCategoryService) QueryProductAttributeCategoryList(ctx context.Context, in *QueryProductAttributeCategoryListReq, opts ...grpc.CallOption) (*QueryProductAttributeCategoryListResp, error) {
	client := pmsclient.NewProductAttributeCategoryServiceClient(m.cli.Conn())
	return client.QueryProductAttributeCategoryList(ctx, in, opts...)
}

// 获取所有商品属性分类及其下属性
func (m *defaultProductAttributeCategoryService) QueryCategoryWithAttrList(ctx context.Context, in *QueryProductAttributeCategoryListReq, opts ...grpc.CallOption) (*QueryProductAttributeCategoryListResp, error) {
	client := pmsclient.NewProductAttributeCategoryServiceClient(m.cli.Conn())
	return client.QueryCategoryWithAttrList(ctx, in, opts...)
}
