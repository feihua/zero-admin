...
func (m *defaultProductLadderService) ProductLadderAdd(ctx context.Context, in *ProductLadderAddReq, opts ...grpc.CallOption) (*ProductLadderAddResp, error) {
	client := pmsclient.NewProductLadderServiceClient(m.cli.Conn())
	return client.ProductLadderAdd(ctx, in, opts...)
}

func (m *defaultProductLadderService) ProductLadderList(ctx context.Context, in *ProductLadderListReq, opts ...grpc.CallOption) (*ProductLadderListResp, error) {
	client := pmsclient.NewProductLadderServiceClient(m.cli.Conn())
	return client.ProductLadderList(ctx, in, opts...)
}

func (m *defaultProductLadderService) ProductLadderUpdate(ctx context.Context, in *ProductLadderUpdateReq, opts ...grpc.CallOption) (*ProductLadderUpdateResp, error) {
	client := pmsclient.NewProductLadderServiceClient(m.cli.Conn())
	return client.ProductLadderUpdate(ctx, in, opts...)
}

func (m *defaultProductLadderService) ProductLadderDelete(ctx context.Context, in *ProductLadderDeleteReq, opts ...grpc.CallOption) (*ProductLadderDeleteResp, error) {
	client := pmsclient.NewProductLadderServiceClient(m.cli.Conn())
