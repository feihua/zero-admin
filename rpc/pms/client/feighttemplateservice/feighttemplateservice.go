...
func (m *defaultFeightTemplateService) FeightTemplateAdd(ctx context.Context, in *FeightTemplateAddReq, opts ...grpc.CallOption) (*FeightTemplateAddResp, error) {
	client := pmsclient.NewFeightTemplateServiceClient(m.cli.Conn())
	return client.FeightTemplateAdd(ctx, in, opts...)
}

func (m *defaultFeightTemplateService) FeightTemplateList(ctx context.Context, in *FeightTemplateListReq, opts ...grpc.CallOption) (*FeightTemplateListResp, error) {
	client := pmsclient.NewFeightTemplateServiceClient(m.cli.Conn())
	return client.FeightTemplateList(ctx, in, opts...)
}

func (m *defaultFeightTemplateService) FeightTemplateUpdate(ctx context.Context, in *FeightTemplateUpdateReq, opts ...grpc.CallOption) (*FeightTemplateUpdateResp, error) {
	client := pmsclient.NewFeightTemplateServiceClient(m.cli.Conn())
	return client.FeightTemplateUpdate(ctx, in, opts...)
}

func (m *defaultFeightTemplateService) FeightTemplateDelete(ctx context.Context, in *FeightTemplateDeleteReq, opts ...grpc.CallOption) (*FeightTemplateDeleteResp, error) {
	client := pmsclient.NewFeightTemplateServiceClient(m.cli.Conn())
