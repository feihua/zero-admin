...
func (m *defaultProductCategoryAttributeRelationService) ProductCategoryAttributeRelationAdd(ctx context.Context, in *ProductCategoryAttributeRelationAddReq, opts ...grpc.CallOption) (*ProductCategoryAttributeRelationAddResp, error) {
...
func (m *defaultProductCategoryAttributeRelationService) ProductCategoryAttributeRelationList(ctx context.Context, in *ProductCategoryAttributeRelationListReq, opts ...grpc.CallOption) (*ProductCategoryAttributeRelationListResp, error) {
	client := pmsclient.NewProductCategoryAttributeRelationServiceClient(m.cli.Conn())
	return client.ProductCategoryAttributeRelationList(ctx, in, opts...)
}

func (m *defaultProductCategoryAttributeRelationService) ProductCategoryAttributeRelationUpdate(ctx context.Context, in *ProductCategoryAttributeRelationUpdateReq, opts ...grpc.CallOption) (*ProductCategoryAttributeRelationUpdateResp, error) {
	client := pmsclient.NewProductCategoryAttributeRelationServiceClient(m.cli.Conn())
	return client.ProductCategoryAttributeRelationUpdate(ctx, in, opts...)
}

func (m *defaultProductCategoryAttributeRelationService) ProductCategoryAttributeRelationDelete(ctx context.Context, in *ProductCategoryAttributeRelationDeleteReq, opts ...grpc.CallOption) (*ProductCategoryAttributeRelationDeleteResp, error) {
	client := pmsclient.NewProductCategoryAttributeRelationServiceClient(m.cli.Conn())
