...
INSERT INTO gozero.sms_coupon (id, type, name, platform, count, amount, per_limit, min_point, start_time, end_time, use_type, note, publish_count, use_count, receive_count, enable_time, code, member_level) VALUES (21, 0, 'xxx11', 0, 100, 10.02, 1, 100.00, '2018-11-10 08:00:00', '2018-12-25 08:00:00', 2, '测试', 100, 0, 0, '2021-03-18 05:06:58', '0000', 0);
INSERT INTO gozero.sms_coupon (id, type, name, platform, count, amount, per_limit, min_point, start_time, end_time, use_type, note, publish_count, use_count, receive_count, enable_time, code, member_level) VALUES (23, 0, '有效期测试', 0, 100, 10.00, 1, 100.00, '2019-10-05 16:00:00', '2023-04-26 07:41:29', 0, '测试', 100, 0, 0, '2021-03-17 13:06:58', 'string', 0);
INSERT INTO gozero.sms_coupon (id, type, name, platform, count, amount, per_limit, min_point, start_time, end_time, use_type, note, publish_count, use_count, receive_count, enable_time, code, member_level) VALUES (25, 0, '小米测试', 0, 10, 100.00, 100, 10.00, '2023-04-20 15:57:24', '2023-05-25 15:57:26', 0, '123', 10, 0, 0, '2023-05-25 15:57:26', '213', 0);
