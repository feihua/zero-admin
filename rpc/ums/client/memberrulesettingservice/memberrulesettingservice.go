...
func (m *defaultMemberRuleSettingService) MemberRuleSettingAdd(ctx context.Context, in *MemberRuleSettingAddReq, opts ...grpc.CallOption) (*MemberRuleSettingAddResp, error) {
	client := umsclient.NewMemberRuleSettingServiceClient(m.cli.Conn())
	return client.MemberRuleSettingAdd(ctx, in, opts...)
}

func (m *defaultMemberRuleSettingService) MemberRuleSettingList(ctx context.Context, in *MemberRuleSettingListReq, opts ...grpc.CallOption) (*MemberRuleSettingListResp, error) {
	client := umsclient.NewMemberRuleSettingServiceClient(m.cli.Conn())
	return client.MemberRuleSettingList(ctx, in, opts...)
}

func (m *defaultMemberRuleSettingService) MemberRuleSettingUpdate(ctx context.Context, in *MemberRuleSettingUpdateReq, opts ...grpc.CallOption) (*MemberRuleSettingUpdateResp, error) {
	client := umsclient.NewMemberRuleSettingServiceClient(m.cli.Conn())
	return client.MemberRuleSettingUpdate(ctx, in, opts...)
}

func (m *defaultMemberRuleSettingService) MemberRuleSettingDelete(ctx context.Context, in *MemberRuleSettingDeleteReq, opts ...grpc.CallOption) (*MemberRuleSettingDeleteResp, error) {
	client := umsclient.NewMemberRuleSettingServiceClient(m.cli.Conn())
