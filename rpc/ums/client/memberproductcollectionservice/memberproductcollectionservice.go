...
func (m *defaultMemberProductCollectionService) MemberProductCollectionUpdate(ctx context.Context, in *MemberProductCollectionUpdateReq, opts ...grpc.CallOption) (*MemberProductCollectionUpdateResp, error) {
	client := umsclient.NewMemberProductCollectionServiceClient(m.cli.Conn())
