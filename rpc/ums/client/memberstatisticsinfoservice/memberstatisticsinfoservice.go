...
func (m *defaultMemberStatisticsInfoService) MemberStatisticsInfoAdd(ctx context.Context, in *MemberStatisticsInfoAddReq, opts ...grpc.CallOption) (*MemberStatisticsInfoAddResp, error) {
	client := umsclient.NewMemberStatisticsInfoServiceClient(m.cli.Conn())
	return client.MemberStatisticsInfoAdd(ctx, in, opts...)
}

func (m *defaultMemberStatisticsInfoService) MemberStatisticsInfoList(ctx context.Context, in *MemberStatisticsInfoListReq, opts ...grpc.CallOption) (*MemberStatisticsInfoListResp, error) {
	client := umsclient.NewMemberStatisticsInfoServiceClient(m.cli.Conn())
	return client.MemberStatisticsInfoList(ctx, in, opts...)
}

func (m *defaultMemberStatisticsInfoService) MemberStatisticsInfoUpdate(ctx context.Context, in *MemberStatisticsInfoUpdateReq, opts ...grpc.CallOption) (*MemberStatisticsInfoUpdateResp, error) {
	client := umsclient.NewMemberStatisticsInfoServiceClient(m.cli.Conn())
	return client.MemberStatisticsInfoUpdate(ctx, in, opts...)
}

func (m *defaultMemberStatisticsInfoService) MemberStatisticsInfoDelete(ctx context.Context, in *MemberStatisticsInfoDeleteReq, opts ...grpc.CallOption) (*MemberStatisticsInfoDeleteResp, error) {
	client := umsclient.NewMemberStatisticsInfoServiceClient(m.cli.Conn())
