...
// UmsMemberRuleSetting mapped from table <ums_member_rule_setting>
type UmsMemberRuleSetting struct {
	...
	RuleType         int32      `gorm:"column:rule_type;not null;default:1;comment:类型：0->积分规则；1->成长值规则" json:"rule_type"`       // 类型：0->积分规则；1->成长值规则
