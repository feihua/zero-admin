...
// UmsMemberTask mapped from table <ums_member_task>
type UmsMemberTask struct {
	...
	TaskType      int32      `gorm:"column:task_type;not null;default:1;comment:任务类型：0-新手任务，1-日常任务，2-周常任务，3-月常任务" json:"task_type"` // 任务类型：0-新手任务，1-日常任务，2-周常任务，3-月常任务
	CompleteCount int32      `gorm:"column:complete_count;not null;comment:需要完成次数" json:"complete_count"`                           // 需要完成次数
	RewardType    int32      `gorm:"column:reward_type;not null;default:1;comment:奖励类型：0-积分成长值，1-优惠券，2-抽奖次数" json:"reward_type"`    // 奖励类型：0-积分成长值，1-优惠券，2-抽奖次数
